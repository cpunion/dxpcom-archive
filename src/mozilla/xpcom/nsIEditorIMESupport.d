...
module mozilla.xpcom.nsIEditorIMESupport;
...
const char[] NS_IEDITORIMESUPPORT_IID_STR = "205b3e49-aa58-499e-880b-aacab9dede01";

const nsIID NS_IEDITORIMESUPPORT_IID= 
  {0x205b3e49, 0xaa58, 0x499e, 
    [ 0x88, 0x0b, 0xaa, 0xca, 0xb9, 0xde, 0xde, 0x01 ]};

extern(Windows)
interface nsIEditorIMESupport : nsISupports {
  static const char[] IID_STR = NS_IEDITORIMESUPPORT_IID_STR;
  ...
  nsresult BeginComposition(nsTextEventReply * aReply);
  ...
  nsresult SetCompositionString(nsAString * aCompositionString, nsIPrivateTextRangeList * aTextRange, nsTextEventReply * aReply);

  /**
   * endComposition() Handles the end of inline input composition.
   */
  /* void endComposition (); */
  nsresult EndComposition();
