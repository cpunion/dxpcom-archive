...
module mozilla.xpcom.nsIMIMEHeaderParam;
...
const char[] NS_IMIMEHEADERPARAM_IID_STR = "ddbbdfb8-a1c0-4dd5-a31b-5d2a7a3bb6ec";

const nsIID NS_IMIMEHEADERPARAM_IID= 
  {0xddbbdfb8, 0xa1c0, 0x4dd5, 
    [ 0xa3, 0x1b, 0x5d, 0x2a, 0x7a, 0x3b, 0xb6, 0xec ]};

extern(Windows)
interface nsIMIMEHeaderParam : nsISupports {
  static const char[] IID_STR = NS_IMIMEHEADERPARAM_IID_STR;
  ...
  nsresult GetParameter(nsACString * aHeaderVal, char *aParamName, nsACString * aFallbackCharset, PRBool aTryLocaleCharset, char **aLang, nsAString * _retval);
  ...
  nsresult GetParameterInternal(char *aHeaderVal, char *aParamName, char **aCharset, char **aLang, char **_retval);
  ...
  nsresult DecodeRFC2047Header(char *aHeaderVal, char *aDefaultCharset, PRBool aOverrideCharset, PRBool aEatContinuation, nsACString * _retval);
  ...
  nsresult DecodeParameter(nsACString * aParamValue, char *aCharset, char *aDefaultCharset, PRBool aOverrideCharset, nsACString * _retval);
