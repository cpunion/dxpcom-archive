...
module mozilla.xpcom.nsIAsyncOutputStream;
...
const char[] NS_IASYNCOUTPUTSTREAM_IID_STR = "10dc9c94-8aff-49c6-8af9-d7fdb7339dae";

const nsIID NS_IASYNCOUTPUTSTREAM_IID= 
...
interface nsIAsyncOutputStream : nsIOutputStream {
  static const char[] IID_STR = NS_IASYNCOUTPUTSTREAM_IID_STR;
  ...
  nsresult AsyncWait(nsIOutputStreamCallback aCallback, PRUint32 aFlags, PRUint32 aRequestedCount, nsIEventTarget aEventTarget);
...
const char[] NS_IOUTPUTSTREAMCALLBACK_IID_STR = "40dbcdff-9053-42c5-a57c-3ec910d0f148";

const nsIID NS_IOUTPUTSTREAMCALLBACK_IID= 
  {0x40dbcdff, 0x9053, 0x42c5, 
    [ 0xa5, 0x7c, 0x3e, 0xc9, 0x10, 0xd0, 0xf1, 0x48 ]};

extern(Windows)
interface nsIOutputStreamCallback : nsISupports {
  static const char[] IID_STR = NS_IOUTPUTSTREAMCALLBACK_IID_STR;
