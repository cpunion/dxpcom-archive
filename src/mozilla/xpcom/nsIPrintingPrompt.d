...
module mozilla.xpcom.nsIPrintingPrompt;
...
const char[] NS_IPRINTINGPROMPT_IID_STR = "44e314ca-75b1-4f3d-9553-9b3507912108";

const nsIID NS_IPRINTINGPROMPT_IID= 
  {0x44e314ca, 0x75b1, 0x4f3d, 
    [ 0x95, 0x53, 0x9b, 0x35, 0x07, 0x91, 0x21, 0x08 ]};

extern(Windows)
interface nsIPrintingPrompt : nsISupports {
  static const char[] IID_STR = NS_IPRINTINGPROMPT_IID_STR;
...
/**
  ...
  nsresult ShowPrintDialog(nsIWebBrowserPrint webBrowserPrint, nsIPrintSettings printSettings);
  ...
  nsresult ShowProgress(nsIWebBrowserPrint webBrowserPrint, nsIPrintSettings printSettings, nsIObserver openDialogObserver, PRBool isForPrinting, nsIWebProgressListener *webProgressListener, nsIPrintProgressParams *printProgressParams, PRBool *notifyOnOpen);
  ...
  nsresult ShowPageSetup(nsIPrintSettings printSettings, nsIObserver aObs);
  ...
  nsresult ShowPrinterProperties(PRUnichar *printerName, nsIPrintSettings printSettings);
