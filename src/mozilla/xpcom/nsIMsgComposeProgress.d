/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIMsgComposeProgress.idl
 */

module mozilla.xpcom.nsIMsgComposeProgress;
...
/* starting interface:    nsIMsgComposeProgress */
const char[] NS_IMSGCOMPOSEPROGRESS_IID_STR = "2080d500-149e-11d5-9daa-e276a42bc27c";

const nsIID NS_IMSGCOMPOSEPROGRESS_IID= 
  {0x2080d500, 0x149e, 0x11d5, 
    [ 0x9d, 0xaa, 0xe2, 0x76, 0xa4, 0x2b, 0xc2, 0x7c ]};

extern(Windows)
interface nsIMsgComposeProgress : nsIWebProgressListener {
  static const char[] IID_STR = NS_IMSGCOMPOSEPROGRESS_IID_STR;
  static const nsIID IID = NS_IMSGCOMPOSEPROGRESS_IID;

  /* void openProgress (in nsIDOMWindowInternal parent, in wstring subject, in boolean itsASaveOperation); */
  nsresult OpenProgress(nsIDOMWindowInternal parent, PRUnichar *subject, PRBool itsASaveOperation);

  /* void closeProgress (in boolean forceClose); */
  nsresult CloseProgress(PRBool forceClose);
