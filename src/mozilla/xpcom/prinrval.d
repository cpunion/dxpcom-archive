/* Converted to D from prinrval.h by htod */
module mozilla.xpcom.prinrval;
...
//C     typedef PRUint32 PRIntervalTime;
extern (Windows):
...
***********************************************************************/
//C     #define PR_INTERVAL_MIN 1000UL
//C     #define PR_INTERVAL_MAX 100000UL
...
***********************************************************************/
//C     #define PR_INTERVAL_NO_WAIT 0UL
//C     #define PR_INTERVAL_NO_TIMEOUT 0xffffffffUL
...
***********************************************************************/
//C     NSPR_API(PRIntervalTime) PR_IntervalNow(void);
...
** ALGORITHM:   N/A
***********************************************************************/
//C     NSPR_API(PRUint32) PR_TicksPerSecond(void);
...
** ALGORITHM:   N/A
***********************************************************************/
//C     NSPR_API(PRIntervalTime) PR_SecondsToInterval(PRUint32 seconds);
PRIntervalTime  PR_SecondsToInterval(PRUint32 seconds);
//C     NSPR_API(PRIntervalTime) PR_MillisecondsToInterval(PRUint32 milli);
PRIntervalTime  PR_MillisecondsToInterval(PRUint32 milli);
//C     NSPR_API(PRIntervalTime) PR_MicrosecondsToInterval(PRUint32 micro);
...
** ALGORITHM:   N/A
***********************************************************************/
//C     NSPR_API(PRUint32) PR_IntervalToSeconds(PRIntervalTime ticks);
PRUint32  PR_IntervalToSeconds(PRIntervalTime ticks);
//C     NSPR_API(PRUint32) PR_IntervalToMilliseconds(PRIntervalTime ticks);
PRUint32  PR_IntervalToMilliseconds(PRIntervalTime ticks);
//C     NSPR_API(PRUint32) PR_IntervalToMicroseconds(PRIntervalTime ticks);
PRUint32  PR_IntervalToMicroseconds(PRIntervalTime ticks);

//C     PR_END_EXTERN_C


//C     #endif /* !defined(prinrval_h) */
