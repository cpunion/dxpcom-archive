...
module mozilla.xpcom.ipcIService;
...
public import mozilla.xpcom.ipcIMessageObserver; /* forward declaration */

public import mozilla.xpcom.ipcIClientObserver; /* forward declaration */


/* starting interface:    ipcIService */
const char[] IPCISERVICE_IID_STR = "53d3e3a7-528f-4b09-9eab-9416272568c0";

const nsIID IPCISERVICE_IID= 
...
interface ipcIService : nsISupports {
  static const char[] IID_STR = IPCISERVICE_IID_STR;
...
/**
  ...
  nsresult DefineTarget(nsID * aTarget, ipcIMessageObserver aObserver, PRBool aOnCurrentThread);
  ...
  nsresult SendMessage(PRUint32 aReceiverID, nsID * aTarget, PRUint8 *aData, PRUint32 aDataLen);
