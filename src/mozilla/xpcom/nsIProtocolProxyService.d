...
module mozilla.xpcom.nsIProtocolProxyService;
...
public import mozilla.xpcom.nsIProtocolProxyCallback; /* forward declaration */

public import mozilla.xpcom.nsIProtocolProxyFilter; /* forward declaration */
...
const char[] NS_IPROTOCOLPROXYSERVICE_IID_STR = "e38ab577-786e-4a7f-936b-7ae4c7d877b2";

const nsIID NS_IPROTOCOLPROXYSERVICE_IID= 
...
interface nsIProtocolProxyService : nsISupports {
  static const char[] IID_STR = NS_IPROTOCOLPROXYSERVICE_IID_STR;
  ...
  nsresult Resolve(nsIURI aURI, PRUint32 aFlags, nsIProxyInfo *_retval);
  ...
  nsresult AsyncResolve(nsIURI aURI, PRUint32 aFlags, nsIProtocolProxyCallback aCallback, nsICancelable *_retval);
  ...
  nsresult NewProxyInfo(nsACString * aType, nsACString * aHost, PRInt32 aPort, PRUint32 aFlags, PRUint32 aFailoverTimeout, nsIProxyInfo aFailoverProxy, nsIProxyInfo *_retval);
  ...
  nsresult RegisterFilter(nsIProtocolProxyFilter aFilter, PRUint32 aPosition);
