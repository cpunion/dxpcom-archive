...
module mozilla.dxpcom.nsIDOM3NodeD;
...
public import mozilla.xpcom.nsIDOMUserDataHandler;

public import mozilla.dxpcom.nsIDOMUserDataHandlerD;


/* starting wrapper class:    nsIDOM3Node */
class nsIDOM3NodeD : public nsISupportsD {

  static const nsIID IID = NS_IDOM3NODE_IID;


  alias nsIDOM3Node InnerType;

  this(nsIDOM3Node intr){
    super(intr);
    this.inner = intr;
  }
  ...
  void opAssign(nsIDOM3Node value) {
    inner = value;
  }
  ...
  wchar[] BaseURI(){
    ...
    nsresult __result = inner.GetBaseURI(cast(nsAString*)value);
  ...
  PRUint16 CompareDocumentPosition(nsIDOMNodeD other){
    PRUint16 _retval;
    nsresult __result = inner.CompareDocumentPosition(other ? cast(nsIDOMNode)other : null, &_retval);
    CheckException(__result);
    return _retval;
  }
  ...
  wchar[] TextContent(){
    scope auto value = new AString();
    nsresult __result = inner.GetTextContent(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void TextContent(wchar[] aTextContent){
    scope auto value = new AString(aTextContent);
    nsresult __result = inner.SetTextContent(cast(nsAString*)value);
    CheckException(__result);
  }

  /* boolean isSameNode (in nsIDOMNode other); */
  PRBool IsSameNode(nsIDOMNodeD other){
    PRBool _retval;
    nsresult __result = inner.IsSameNode(other ? cast(nsIDOMNode)other : null, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* DOMString lookupPrefix (in DOMString namespaceURI); */
  wchar[] LookupPrefix(wchar[] namespaceURI){
    scope auto _namespaceURI = new AString(namespaceURI);
    scope auto _retval = new AString;
    nsresult __result = inner.LookupPrefix(cast(nsAString*)_namespaceURI, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }

  /* boolean isDefaultNamespace (in DOMString namespaceURI); */
  PRBool IsDefaultNamespace(wchar[] namespaceURI){
    scope auto _namespaceURI = new AString(namespaceURI);
    PRBool _retval;
    nsresult __result = inner.IsDefaultNamespace(cast(nsAString*)_namespaceURI, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* DOMString lookupNamespaceURI (in DOMString prefix); */
  wchar[] LookupNamespaceURI(wchar[] prefix){
    scope auto _prefix = new AString(prefix);
    scope auto _retval = new AString;
    nsresult __result = inner.LookupNamespaceURI(cast(nsAString*)_prefix, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }

  /* boolean isEqualNode (in nsIDOMNode arg); */
  PRBool IsEqualNode(nsIDOMNodeD arg){
    PRBool _retval;
    nsresult __result = inner.IsEqualNode(arg ? cast(nsIDOMNode)arg : null, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* nsISupports getFeature (in DOMString feature, in DOMString version); */
  nsISupportsD  GetFeature(wchar[] feature, wchar[] version_){
    scope auto _feature = new AString(feature);
    scope auto _version = new AString(version_);
    nsISupports _retval;
    nsresult __result = inner.GetFeature(cast(nsAString*)_feature, cast(nsAString*)_version, &_retval);
    CheckException(__result);
  ...
  nsIVariantD  SetUserData(wchar[] key, nsIVariantD data, nsIDOMUserDataHandlerD handler){
    scope auto _key = new AString(key);
    nsIVariant _retval;
    nsresult __result = inner.SetUserData(cast(nsAString*)_key, data ? cast(nsIVariant)data : null, handler ? cast(nsIDOMUserDataHandler)handler : null, &_retval);
    CheckException(__result);
    return new nsIVariantD(_retval);
  }

  /* nsIVariant getUserData (in DOMString key); */
  nsIVariantD  GetUserData(wchar[] key){
    scope auto _key = new AString(key);
    nsIVariant _retval;
    nsresult __result = inner.GetUserData(cast(nsAString*)_key, &_retval);
    CheckException(__result);
    return new nsIVariantD(_retval);
  }
