...
module mozilla.dxpcom.nsIDOMXPathNSResolverD;
...
/* starting wrapper class:    nsIDOMXPathNSResolver */
class nsIDOMXPathNSResolverD : public nsISupportsD {

  static const nsIID IID = NS_IDOMXPATHNSRESOLVER_IID;


  alias nsIDOMXPathNSResolver InnerType;

  this(nsIDOMXPathNSResolver intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMXPathNSResolver opCast() {
    return inner;
  }

  void opAssign(nsIDOMXPathNSResolver value) {
    inner = value;
  }
