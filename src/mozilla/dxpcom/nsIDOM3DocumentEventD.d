...
module mozilla.dxpcom.nsIDOM3DocumentEventD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOM3DocumentEvent;


public import mozilla.dxpcom.nsIDOM3DocumentEventD;
...
/* starting wrapper class:    nsIDOM3DocumentEvent */
/**
 ...
 */
class nsIDOM3DocumentEventD : public nsISupportsD {

  static const nsIID IID = NS_IDOM3DOCUMENTEVENT_IID;


  alias nsIDOM3DocumentEvent InnerType;

  this(nsIDOM3DocumentEvent intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOM3DocumentEvent opCast() {
    return inner;
  }

  void opAssign(nsIDOM3DocumentEvent value) {
    inner = value;
  }

  /* nsIDOMEventGroup createEventGroup (); */
  nsIDOMEventGroupD  CreateEventGroup(){
    nsIDOMEventGroup _retval;
    nsresult __result = inner.CreateEventGroup(&_retval);
    CheckException(__result);
    return new nsIDOMEventGroupD(_retval);
  }

private:
  nsIDOM3DocumentEvent inner;
