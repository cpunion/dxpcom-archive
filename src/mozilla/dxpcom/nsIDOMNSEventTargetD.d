...
module mozilla.dxpcom.nsIDOMNSEventTargetD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSEventTarget;


public import mozilla.dxpcom.nsIDOMNSEventTargetD;
...
/* starting wrapper class:    nsIDOMNSEventTarget */
/**
 ...
 */
class nsIDOMNSEventTargetD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSEVENTTARGET_IID;


  alias nsIDOMNSEventTarget InnerType;

  this(nsIDOMNSEventTarget intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSEventTarget opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSEventTarget value) {
    inner = value;
  }
  ...
  void AddEventListener(wchar[] type, nsIDOMEventListenerD listener, PRBool useCapture, PRBool wantsUntrusted){
    scope auto _type = new AString(type);
    nsresult __result = inner.AddEventListener(cast(nsAString*)_type, listener ? cast(nsIDOMEventListener)listener : null, useCapture, wantsUntrusted);
    CheckException(__result);
  }

private:
  nsIDOMNSEventTarget inner;
