...
module mozilla.dxpcom.nsIDOMNavigatorD;
...
/* starting wrapper class:    nsIDOMNavigator */
class nsIDOMNavigatorD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNAVIGATOR_IID;


  alias nsIDOMNavigator InnerType;

  this(nsIDOMNavigator intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNavigator opCast() {
    return inner;
  }

  void opAssign(nsIDOMNavigator value) {
    inner = value;
  }
  ...
  wchar[] AppCodeName(){
    ...
    nsresult __result = inner.GetAppCodeName(cast(nsAString*)value);
  ...
  wchar[] AppName(){
    scope auto value = new AString();
    nsresult __result = inner.GetAppName(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] AppVersion(){
    scope auto value = new AString();
    nsresult __result = inner.GetAppVersion(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] Language(){
    scope auto value = new AString();
    nsresult __result = inner.GetLanguage(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }

  /* readonly attribute nsIDOMMimeTypeArray mimeTypes; */
  nsIDOMMimeTypeArrayD  MimeTypes(){
    nsIDOMMimeTypeArray value;
    nsresult __result = inner.GetMimeTypes(&value);
    CheckException(__result);
    return new nsIDOMMimeTypeArrayD(value);
  }

  /* readonly attribute DOMString platform; */
  wchar[] Platform(){
    scope auto value = new AString();
    nsresult __result = inner.GetPlatform(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] Oscpu(){
    scope auto value = new AString();
    nsresult __result = inner.GetOscpu(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] Vendor(){
    scope auto value = new AString();
    nsresult __result = inner.GetVendor(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] VendorSub(){
    scope auto value = new AString();
    nsresult __result = inner.GetVendorSub(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] Product(){
    scope auto value = new AString();
    nsresult __result = inner.GetProduct(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] ProductSub(){
    scope auto value = new AString();
    nsresult __result = inner.GetProductSub(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }

  /* readonly attribute nsIDOMPluginArray plugins; */
  nsIDOMPluginArrayD  Plugins(){
    nsIDOMPluginArray value;
    nsresult __result = inner.GetPlugins(&value);
    CheckException(__result);
    return new nsIDOMPluginArrayD(value);
  }

  /* readonly attribute DOMString securityPolicy; */
  wchar[] SecurityPolicy(){
    scope auto value = new AString();
    nsresult __result = inner.GetSecurityPolicy(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] UserAgent(){
    scope auto value = new AString();
    nsresult __result = inner.GetUserAgent(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }

  /* readonly attribute boolean cookieEnabled; */
  PRBool CookieEnabled(){
    PRBool value;
    nsresult __result = inner.GetCookieEnabled(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRBool OnLine(){
    PRBool value;
    nsresult __result = inner.GetOnLine(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRBool JavaEnabled(){
    PRBool _retval;
    nsresult __result = inner.JavaEnabled(&_retval);
    CheckException(__result);
    return _retval;
  }
  ...
  PRBool TaintEnabled(){
    PRBool _retval;
    nsresult __result = inner.TaintEnabled(&_retval);
    CheckException(__result);
    return _retval;
  }

private:
  nsIDOMNavigator inner;

}


/* starting wrapper class:    nsIDOMJSNavigator */
class nsIDOMJSNavigatorD : public nsISupportsD {

  static const nsIID IID = NS_IDOMJSNAVIGATOR_IID;


  alias nsIDOMJSNavigator InnerType;

  this(nsIDOMJSNavigator intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMJSNavigator opCast() {
    return inner;
  }

  void opAssign(nsIDOMJSNavigator value) {
    inner = value;
  }

  /* void preference (); */
  void Preference(){
    nsresult __result = inner.Preference();
    CheckException(__result);
  }

private:
  nsIDOMJSNavigator inner;

}


/* starting wrapper class:    nsIDOMNavigator_MOZILLA_1_8_BRANCH */
class nsIDOMNavigator_MOZILLA_1_8_BRANCHD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNAVIGATOR_MOZILLA_1_8_BRANCH_IID;


  alias nsIDOMNavigator_MOZILLA_1_8_BRANCH InnerType;

  this(nsIDOMNavigator_MOZILLA_1_8_BRANCH intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNavigator_MOZILLA_1_8_BRANCH opCast() {
    return inner;
  }

  void opAssign(nsIDOMNavigator_MOZILLA_1_8_BRANCH value) {
    inner = value;
  }
...
private:
  nsIDOMNavigator_MOZILLA_1_8_BRANCH inner;
