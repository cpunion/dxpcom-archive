...
module mozilla.dxpcom.nsIDOMSVGExceptionD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGException;


public import mozilla.dxpcom.nsIDOMSVGExceptionD;
...
/* starting wrapper class:    nsIDOMSVGException */
class nsIDOMSVGExceptionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGEXCEPTION_IID;


  alias nsIDOMSVGException InnerType;

  this(nsIDOMSVGException intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGException opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGException value) {
    inner = value;
  }
