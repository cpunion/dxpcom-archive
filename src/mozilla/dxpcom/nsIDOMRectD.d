...
module mozilla.dxpcom.nsIDOMRectD;
...
/* starting wrapper class:    nsIDOMRect */
class nsIDOMRectD : public nsISupportsD {

  static const nsIID IID = NS_IDOMRECT_IID;


  alias nsIDOMRect InnerType;

  this(nsIDOMRect intr){
    super(intr);
    this.inner = intr;
  }
  ...
  void opAssign(nsIDOMRect value) {
    inner = value;
  }

  /* readonly attribute nsIDOMCSSPrimitiveValue top; */
  nsIDOMCSSPrimitiveValueD  Top(){
  ...
  nsIDOMCSSPrimitiveValueD  Right(){
    nsIDOMCSSPrimitiveValue value;
    nsresult __result = inner.GetRight(&value);
    CheckException(__result);
    return new nsIDOMCSSPrimitiveValueD(value);
  }

  /* readonly attribute nsIDOMCSSPrimitiveValue bottom; */
  nsIDOMCSSPrimitiveValueD  Bottom(){
    nsIDOMCSSPrimitiveValue value;
    nsresult __result = inner.GetBottom(&value);
    CheckException(__result);
    return new nsIDOMCSSPrimitiveValueD(value);
  }

  /* readonly attribute nsIDOMCSSPrimitiveValue left; */
  nsIDOMCSSPrimitiveValueD  Left(){
    nsIDOMCSSPrimitiveValue value;
    nsresult __result = inner.GetLeft(&value);
    CheckException(__result);
    return new nsIDOMCSSPrimitiveValueD(value);
  }
