...
module mozilla.dxpcom.nsIDOMScreenD;
...
/* starting wrapper class:    nsIDOMScreen */
class nsIDOMScreenD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSCREEN_IID;


  alias nsIDOMScreen InnerType;

  this(nsIDOMScreen intr){
    super(intr);
    this.inner = intr;
  }
  ...
  void opAssign(nsIDOMScreen value) {
    inner = value;
  }
  ...
  PRInt32 AvailWidth(){
    PRInt32 value;
    nsresult __result = inner.GetAvailWidth(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 AvailHeight(){
    PRInt32 value;
    nsresult __result = inner.GetAvailHeight(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 AvailLeft(){
    PRInt32 value;
    nsresult __result = inner.GetAvailLeft(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 AvailTop(){
    PRInt32 value;
    nsresult __result = inner.GetAvailTop(&value);
    CheckException(__result);
    return value;
  }
