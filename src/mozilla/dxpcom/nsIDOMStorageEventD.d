...
module mozilla.dxpcom.nsIDOMStorageEventD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMStorageEvent;


public import mozilla.dxpcom.nsIDOMStorageEventD;
...
/* starting wrapper class:    nsIDOMStorageEvent */
/**
 ...
 */
class nsIDOMStorageEventD : public nsIDOMEventD {

  static const nsIID IID = NS_IDOMSTORAGEEVENT_IID;


  alias nsIDOMStorageEvent InnerType;

  this(nsIDOMStorageEvent intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMStorageEvent opCast() {
    return inner;
  }

  void opAssign(nsIDOMStorageEvent value) {
    inner = value;
  }
  ...
  void InitStorageEvent(wchar[] typeArg, PRBool canBubbleArg, PRBool cancelableArg, wchar[] domainArg){
    scope auto _typeArg = new AString(typeArg);
    scope auto _domainArg = new AString(domainArg);
    nsresult __result = inner.InitStorageEvent(cast(nsAString*)_typeArg, canBubbleArg, cancelableArg, cast(nsAString*)_domainArg);
    CheckException(__result);
  }
  ...
  void InitStorageEventNS(wchar[] namespaceURIArg, wchar[] typeArg, PRBool canBubbleArg, PRBool cancelableArg, wchar[] domainArg){
    scope auto _namespaceURIArg = new AString(namespaceURIArg);
    scope auto _typeArg = new AString(typeArg);
    scope auto _domainArg = new AString(domainArg);
    nsresult __result = inner.InitStorageEventNS(cast(nsAString*)_namespaceURIArg, cast(nsAString*)_typeArg, canBubbleArg, cancelableArg, cast(nsAString*)_domainArg);
    CheckException(__result);
  }

private:
  nsIDOMStorageEvent inner;
