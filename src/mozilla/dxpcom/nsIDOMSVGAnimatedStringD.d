...
module mozilla.dxpcom.nsIDOMSVGAnimatedStringD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedString */
class nsIDOMSVGAnimatedStringD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDSTRING_IID;


  alias nsIDOMSVGAnimatedString InnerType;

  this(nsIDOMSVGAnimatedString intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedString opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedString value) {
    inner = value;
  }
  ...
  wchar[] BaseVal(){
    ...
    nsresult __result = inner.GetBaseVal(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void BaseVal(wchar[] aBaseVal){
    scope auto value = new AString(aBaseVal);
    nsresult __result = inner.SetBaseVal(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] AnimVal(){
    scope auto value = new AString();
    nsresult __result = inner.GetAnimVal(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }

private:
  nsIDOMSVGAnimatedString inner;
