...
module mozilla.dxpcom.nsIDOMSVGAnimatedLengthD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedLength */
class nsIDOMSVGAnimatedLengthD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDLENGTH_IID;


  alias nsIDOMSVGAnimatedLength InnerType;

  this(nsIDOMSVGAnimatedLength intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedLength opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedLength value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGLength baseVal; */
  nsIDOMSVGLengthD  BaseVal(){
    nsIDOMSVGLength value;
    nsresult __result = inner.GetBaseVal(&value);
    CheckException(__result);
    return new nsIDOMSVGLengthD(value);
  }

  /* readonly attribute nsIDOMSVGLength animVal; */
  nsIDOMSVGLengthD  AnimVal(){
    nsIDOMSVGLength value;
