...
module mozilla.dxpcom.nsIDOMNSHTMLSelectElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLSelectElement;


public import mozilla.dxpcom.nsIDOMNSHTMLSelectElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLSelectElement */
class nsIDOMNSHTMLSelectElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLSELECTELEMENT_IID;


  alias nsIDOMNSHTMLSelectElement InnerType;

  this(nsIDOMNSHTMLSelectElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLSelectElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLSelectElement value) {
    inner = value;
  }
...
private:
  nsIDOMNSHTMLSelectElement inner;
