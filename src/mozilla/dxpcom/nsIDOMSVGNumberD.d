...
module mozilla.dxpcom.nsIDOMSVGNumberD;
...
/* starting wrapper class:    nsIDOMSVGNumber */
class nsIDOMSVGNumberD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGNUMBER_IID;


  alias nsIDOMSVGNumber InnerType;

  this(nsIDOMSVGNumber intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGNumber opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGNumber value) {
    inner = value;
  }
