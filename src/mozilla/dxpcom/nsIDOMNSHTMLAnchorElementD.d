...
module mozilla.dxpcom.nsIDOMNSHTMLAnchorElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLAnchorElement;


public import mozilla.dxpcom.nsIDOMNSHTMLAnchorElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLAnchorElement */
class nsIDOMNSHTMLAnchorElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLANCHORELEMENT_IID;


  alias nsIDOMNSHTMLAnchorElement InnerType;

  this(nsIDOMNSHTMLAnchorElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLAnchorElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLAnchorElement value) {
    inner = value;
  }
...
private:
  nsIDOMNSHTMLAnchorElement inner;
