...
module mozilla.dxpcom.nsIDOMSVGAnimatedRectD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedRect */
class nsIDOMSVGAnimatedRectD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDRECT_IID;


  alias nsIDOMSVGAnimatedRect InnerType;

  this(nsIDOMSVGAnimatedRect intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedRect opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedRect value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGRect baseVal; */
  nsIDOMSVGRectD  BaseVal(){
    nsIDOMSVGRect value;
