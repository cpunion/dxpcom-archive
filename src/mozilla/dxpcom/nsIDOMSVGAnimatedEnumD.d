...
module mozilla.dxpcom.nsIDOMSVGAnimatedEnumD;
...
public import mozilla.dxpcom.nsIDOMSVGAnimatedEnumD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedEnumeration */
class nsIDOMSVGAnimatedEnumerationD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDENUMERATION_IID;


  alias nsIDOMSVGAnimatedEnumeration InnerType;

  this(nsIDOMSVGAnimatedEnumeration intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedEnumeration opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedEnumeration value) {
    inner = value;
  }
  ...
  void BaseVal(PRUint16 aBaseVal){
    nsresult __result = inner.SetBaseVal(aBaseVal);
    CheckException(__result);
  }
...
private:
  nsIDOMSVGAnimatedEnumeration inner;
