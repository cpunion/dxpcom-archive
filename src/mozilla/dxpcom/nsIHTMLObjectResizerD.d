...
module mozilla.dxpcom.nsIHTMLObjectResizerD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIHTMLObjectResizer;


public import mozilla.dxpcom.nsIHTMLObjectResizerD;
...
public import mozilla.xpcom.nsIHTMLObjectResizeListener;

public import mozilla.dxpcom.nsIHTMLObjectResizeListenerD;


/* starting wrapper class:    nsIHTMLObjectResizer */
class nsIHTMLObjectResizerD : public nsISupportsD {

  static const nsIID IID = NS_IHTMLOBJECTRESIZER_IID;


  alias nsIHTMLObjectResizer InnerType;

  this(nsIHTMLObjectResizer intr){
    super(intr);
    this.inner = intr;
  }

  nsIHTMLObjectResizer opCast() {
    return inner;
  }

  void opAssign(nsIHTMLObjectResizer value) {
    inner = value;
  }
  ...
  nsIDOMElementD  ResizedObject(){
    nsIDOMElement value;
    nsresult __result = inner.GetResizedObject(&value);
  ...
  PRBool ObjectResizingEnabled(){
    PRBool value;
    nsresult __result = inner.GetObjectResizingEnabled(&value);
    CheckException(__result);
    return value;
  }
  void ObjectResizingEnabled(PRBool aObjectResizingEnabled){
    nsresult __result = inner.SetObjectResizingEnabled(aObjectResizingEnabled);
    CheckException(__result);
  }
  ...
  void ShowResizers(nsIDOMElementD aResizedElement){
    nsresult __result = inner.ShowResizers(aResizedElement ? cast(nsIDOMElement)aResizedElement : null);
    CheckException(__result);
  }
  ...
  /* void hideResizers (); */
  void HideResizers(){
    nsresult __result = inner.HideResizers();
    CheckException(__result);
  }
  ...
  void RefreshResizers(){
    nsresult __result = inner.RefreshResizers();
    CheckException(__result);
  }
  ...
  void MouseDown(PRInt32 aX, PRInt32 aY, nsIDOMElementD aTarget){
    nsresult __result = inner.MouseDown(aX, aY, aTarget ? cast(nsIDOMElement)aTarget : null);
    CheckException(__result);
  }
  ...
  void MouseUp(PRInt32 aX, PRInt32 aY, nsIDOMElementD aTarget){
    nsresult __result = inner.MouseUp(aX, aY, aTarget ? cast(nsIDOMElement)aTarget : null);
    CheckException(__result);
  }
  ...
  void MouseMove(nsIDOMEventD aMouseEvent){
    nsresult __result = inner.MouseMove(aMouseEvent ? cast(nsIDOMEvent)aMouseEvent : null);
    CheckException(__result);
  }
  ...
  void AddObjectResizeEventListener(nsIHTMLObjectResizeListenerD aListener){
    nsresult __result = inner.AddObjectResizeEventListener(aListener ? cast(nsIHTMLObjectResizeListener)aListener : null);
    CheckException(__result);
  }
  ...
  void RemoveObjectResizeEventListener(nsIHTMLObjectResizeListenerD aListener){
    nsresult __result = inner.RemoveObjectResizeEventListener(aListener ? cast(nsIHTMLObjectResizeListener)aListener : null);
    CheckException(__result);
  }

private:
  nsIHTMLObjectResizer inner;
