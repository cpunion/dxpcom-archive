...
module mozilla.dxpcom.nsIXSLTExceptionD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIXSLTException;


public import mozilla.dxpcom.nsIXSLTExceptionD;
...
/* starting wrapper class:    nsIXSLTException */
class nsIXSLTExceptionD : public nsIExceptionD {

  static const nsIID IID = NS_IXSLTEXCEPTION_IID;


  alias nsIXSLTException InnerType;

  this(nsIXSLTException intr){
    super(intr);
    this.inner = intr;
  }

  nsIXSLTException opCast() {
    return inner;
  }

  void opAssign(nsIXSLTException value) {
    inner = value;
  }
  ...
  nsIDOMNodeD  StyleNode(){
    nsIDOMNode value;
    nsresult __result = inner.GetStyleNode(&value);
