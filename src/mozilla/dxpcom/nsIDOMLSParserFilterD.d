...
module mozilla.dxpcom.nsIDOMLSParserFilterD;
...
/* starting wrapper class:    nsIDOMLSParserFilter */
class nsIDOMLSParserFilterD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLSPARSERFILTER_IID;


  alias nsIDOMLSParserFilter InnerType;

  this(nsIDOMLSParserFilter intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLSParserFilter opCast() {
    return inner;
  }

  void opAssign(nsIDOMLSParserFilter value) {
    inner = value;
  }
  ...
  PRUint16 StartElement(nsIDOMElementD elementArg){
    PRUint16 _retval;
    nsresult __result = inner.StartElement(elementArg ? cast(nsIDOMElement)elementArg : null, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* unsigned short acceptNode (in nsIDOMNode nodeArg); */
  PRUint16 AcceptNode(nsIDOMNodeD nodeArg){
    PRUint16 _retval;
    nsresult __result = inner.AcceptNode(nodeArg ? cast(nsIDOMNode)nodeArg : null, &_retval);
    CheckException(__result);
    return _retval;
  }
