/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIDOMNSHistory.idl
 */

module mozilla.dxpcom.nsIDOMNSHistoryD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHistory;


public import mozilla.dxpcom.nsIDOMNSHistoryD;
...
/* starting wrapper class:    nsIDOMNSHistory */
class nsIDOMNSHistoryD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHISTORY_IID;


  alias nsIDOMNSHistory InnerType;

  this(nsIDOMNSHistory intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHistory opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHistory value) {
    inner = value;
  }
  ...
  /* void go (); */
  void Go(){
    nsresult __result = inner.Go();
    CheckException(__result);
  }

private:
  nsIDOMNSHistory inner;
