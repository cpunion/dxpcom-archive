...
module mozilla.dxpcom.nsIDOM3EventTargetD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOM3EventTarget;


public import mozilla.dxpcom.nsIDOM3EventTargetD;
...
/* starting wrapper class:    nsIDOM3EventTarget */
/**
 ...
 */
class nsIDOM3EventTargetD : public nsISupportsD {

  static const nsIID IID = NS_IDOM3EVENTTARGET_IID;


  alias nsIDOM3EventTarget InnerType;

  this(nsIDOM3EventTarget intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOM3EventTarget opCast() {
    return inner;
  }

  void opAssign(nsIDOM3EventTarget value) {
    inner = value;
  }
  ...
  void AddGroupedEventListener(wchar[] type, nsIDOMEventListenerD listener, PRBool useCapture, nsIDOMEventGroupD evtGroup){
    scope auto _type = new AString(type);
    nsresult __result = inner.AddGroupedEventListener(cast(nsAString*)_type, listener ? cast(nsIDOMEventListener)listener : null, useCapture, evtGroup ? cast(nsIDOMEventGroup)evtGroup : null);
  ...
  void RemoveGroupedEventListener(wchar[] type, nsIDOMEventListenerD listener, PRBool useCapture, nsIDOMEventGroupD evtGroup){
    scope auto _type = new AString(type);
    nsresult __result = inner.RemoveGroupedEventListener(cast(nsAString*)_type, listener ? cast(nsIDOMEventListener)listener : null, useCapture, evtGroup ? cast(nsIDOMEventGroup)evtGroup : null);
    CheckException(__result);
  }

  /* boolean canTrigger (in DOMString type); */
  PRBool CanTrigger(wchar[] type){
    scope auto _type = new AString(type);
    PRBool _retval;
    nsresult __result = inner.CanTrigger(cast(nsAString*)_type, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* boolean isRegisteredHere (in DOMString type); */
  PRBool IsRegisteredHere(wchar[] type){
    scope auto _type = new AString(type);
    PRBool _retval;
    nsresult __result = inner.IsRegisteredHere(cast(nsAString*)_type, &_retval);
    CheckException(__result);
    return _retval;
  }

private:
  nsIDOM3EventTarget inner;
