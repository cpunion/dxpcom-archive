...
module mozilla.dxpcom.nsILDAPErrorsD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsILDAPErrors;


public import mozilla.dxpcom.nsILDAPErrorsD;

public import mozilla.xpcom.nsISupports;
public import mozilla.dxpcom.nsISupportsD;


/* starting wrapper class:    nsILDAPErrors */
/**
 ...
 *
 */
class nsILDAPErrorsD : public nsISupportsD {

  static const nsIID IID = NS_ILDAPERRORS_IID;


  alias nsILDAPErrors InnerType;

  this(nsILDAPErrors intr){
    super(intr);
    this.inner = intr;
  }

  nsILDAPErrors opCast() {
    return inner;
  }

  void opAssign(nsILDAPErrors value) {
    inner = value;
  }
