...
module mozilla.dxpcom.nsIDOMSVGAnimatedNumberListD;
...
public import mozilla.xpcom.nsIDOMSVGNumberList;

public import mozilla.dxpcom.nsIDOMSVGNumberListD;


/* starting wrapper class:    nsIDOMSVGAnimatedNumberList */
class nsIDOMSVGAnimatedNumberListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDNUMBERLIST_IID;


  alias nsIDOMSVGAnimatedNumberList InnerType;

  this(nsIDOMSVGAnimatedNumberList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedNumberList opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedNumberList value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGNumberList baseVal; */
  nsIDOMSVGNumberListD  BaseVal(){
    nsIDOMSVGNumberList value;
    nsresult __result = inner.GetBaseVal(&value);
    CheckException(__result);
    return new nsIDOMSVGNumberListD(value);
  }

  /* readonly attribute nsIDOMSVGNumberList animVal; */
  nsIDOMSVGNumberListD  AnimVal(){
    nsIDOMSVGNumberList value;
...
private:
  nsIDOMSVGAnimatedNumberList inner;
