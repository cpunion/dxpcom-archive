...
module mozilla.dxpcom.nsIDOMXPathExceptionD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMXPathException;


public import mozilla.dxpcom.nsIDOMXPathExceptionD;
...
/* starting wrapper class:    nsIDOMXPathException */
class nsIDOMXPathExceptionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMXPATHEXCEPTION_IID;


  alias nsIDOMXPathException InnerType;

  this(nsIDOMXPathException intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMXPathException opCast() {
    return inner;
  }

  void opAssign(nsIDOMXPathException value) {
    inner = value;
  }
