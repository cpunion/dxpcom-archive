...
module mozilla.dxpcom.nsIDOMSVGAnimatedAngleD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedAngle */
/**
 ...
 *
 */
class nsIDOMSVGAnimatedAngleD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDANGLE_IID;


  alias nsIDOMSVGAnimatedAngle InnerType;

  this(nsIDOMSVGAnimatedAngle intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedAngle opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedAngle value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGAngle baseVal; */
  nsIDOMSVGAngleD  BaseVal(){
    nsIDOMSVGAngle value;
    nsresult __result = inner.GetBaseVal(&value);
    CheckException(__result);
    return new nsIDOMSVGAngleD(value);
  }

  /* readonly attribute nsIDOMSVGAngle animVal; */
  nsIDOMSVGAngleD  AnimVal(){
    nsIDOMSVGAngle value;
