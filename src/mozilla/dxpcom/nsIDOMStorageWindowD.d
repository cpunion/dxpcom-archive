...
module mozilla.dxpcom.nsIDOMStorageWindowD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMStorageWindow;


public import mozilla.dxpcom.nsIDOMStorageWindowD;
...
public import mozilla.xpcom.nsIDOMStorageList;

public import mozilla.dxpcom.nsIDOMStorageListD;


/* starting wrapper class:    nsIDOMStorageWindow */
class nsIDOMStorageWindowD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSTORAGEWINDOW_IID;


  alias nsIDOMStorageWindow InnerType;

  this(nsIDOMStorageWindow intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMStorageWindow opCast() {
    return inner;
  }

  void opAssign(nsIDOMStorageWindow value) {
    inner = value;
  }
  ...
  nsIDOMStorageD  SessionStorage(){
    nsIDOMStorage value;
    nsresult __result = inner.GetSessionStorage(&value);
    CheckException(__result);
    return new nsIDOMStorageD(value);
  }
  ...
  nsIDOMStorageListD  GlobalStorage(){
    nsIDOMStorageList value;
    nsresult __result = inner.GetGlobalStorage(&value);
    CheckException(__result);
    return new nsIDOMStorageListD(value);
  }

private:
  nsIDOMStorageWindow inner;
