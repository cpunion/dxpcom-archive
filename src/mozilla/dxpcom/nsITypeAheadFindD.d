...
module mozilla.dxpcom.nsITypeAheadFindD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsITypeAheadFind;


public import mozilla.dxpcom.nsITypeAheadFindD;
...
/* starting wrapper class:    nsITypeAheadFind */
/****************************** nsTypeAheadFind ******************************/
class nsITypeAheadFindD : public nsISupportsD {

  static const nsIID IID = NS_ITYPEAHEADFIND_IID;


  alias nsITypeAheadFind InnerType;

  this(nsITypeAheadFind intr){
    super(intr);
    this.inner = intr;
  }

  nsITypeAheadFind opCast() {
    return inner;
  }

  void opAssign(nsITypeAheadFind value) {
    inner = value;
  }

  /****************************** Initializer ******************************/
  /* void init (in nsIDocShell aDocShell); */
  void Init(nsIDocShellD aDocShell){
    nsresult __result = inner.Init(aDocShell ? cast(nsIDocShell)aDocShell : null);
    CheckException(__result);
  }

  /***************************** Core functions ****************************/
  /* unsigned short find (in AString aSearchString, in boolean aLinksOnly); */
  PRUint16 Find(wchar[] aSearchString, PRBool aLinksOnly){
    scope auto _aSearchString = new AString(aSearchString);
    PRUint16 _retval;
    nsresult __result = inner.Find(cast(nsAString*)_aSearchString, aLinksOnly, &_retval);
    CheckException(__result);
    return _retval;
  }
  ...
  PRUint16 FindPrevious(){
    PRUint16 _retval;
    nsresult __result = inner.FindPrevious(&_retval);
    CheckException(__result);
    return _retval;
  }
  ...
  void SetDocShell(nsIDocShellD aDocShell){
    nsresult __result = inner.SetDocShell(aDocShell ? cast(nsIDocShell)aDocShell : null);
    CheckException(__result);
  }
  ...
  PRBool FocusLinks(){
    PRBool value;
    nsresult __result = inner.GetFocusLinks(&value);
    CheckException(__result);
    return value;
  }
  void FocusLinks(PRBool aFocusLinks){
    nsresult __result = inner.SetFocusLinks(aFocusLinks);
    CheckException(__result);
  }
  ...
  nsIDOMElementD  FoundLink(){
    nsIDOMElement value;
    nsresult __result = inner.GetFoundLink(&value);
    CheckException(__result);
    return new nsIDOMElementD(value);
  }

  /* readonly attribute nsIDOMWindow currentWindow; */
  nsIDOMWindowD  CurrentWindow(){
    nsIDOMWindow value;
    nsresult __result = inner.GetCurrentWindow(&value);
    CheckException(__result);
...
private:
  nsITypeAheadFind inner;

}


/* starting wrapper class:    nsITypeAheadFind_MOZILLA_1_8_BRANCH */
/*************************************************************************/
/********************* nsTypeAheadFind_MOZILLA_1_8_BRANCH ********************/
class nsITypeAheadFind_MOZILLA_1_8_BRANCHD : public nsITypeAheadFindD {

  static const nsIID IID = NS_ITYPEAHEADFIND_MOZILLA_1_8_BRANCH_IID;


  alias nsITypeAheadFind_MOZILLA_1_8_BRANCH InnerType;

  this(nsITypeAheadFind_MOZILLA_1_8_BRANCH intr){
    super(intr);
    this.inner = intr;
  }

  nsITypeAheadFind_MOZILLA_1_8_BRANCH opCast() {
    return inner;
  }

  void opAssign(nsITypeAheadFind_MOZILLA_1_8_BRANCH value) {
    inner = value;
  }
  ...
  void SetSelectionModeAndRepaint(PRInt16 toggle){
    nsresult __result = inner.SetSelectionModeAndRepaint(toggle);
    CheckException(__result);
  }

  /* void collapseSelection (); */
  void CollapseSelection(){
    nsresult __result = inner.CollapseSelection();
    CheckException(__result);
  }

  /******************************* Attributes ******************************/
  /* readonly attribute nsIDOMElement foundEditable; */
  nsIDOMElementD  FoundEditable(){
    nsIDOMElement value;
    nsresult __result = inner.GetFoundEditable(&value);
    CheckException(__result);
    return new nsIDOMElementD(value);
  }

private:
  nsITypeAheadFind_MOZILLA_1_8_BRANCH inner;
