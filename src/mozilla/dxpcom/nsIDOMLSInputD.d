...
module mozilla.dxpcom.nsIDOMLSInputD;
...
/* starting wrapper class:    nsIDOMLSInput */
class nsIDOMLSInputD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLSINPUT_IID;


  alias nsIDOMLSInput InnerType;

  this(nsIDOMLSInput intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLSInput opCast() {
    return inner;
  }

  void opAssign(nsIDOMLSInput value) {
    inner = value;
  }

  /* attribute nsISupports characterStream; */
  nsISupportsD  CharacterStream(){
    nsISupports value;
    nsresult __result = inner.GetCharacterStream(&value);
    CheckException(__result);
    return new nsISupportsD(value);
  }
  void CharacterStream(nsISupportsD  aCharacterStream){
    nsISupports value;
    nsresult __result = inner.SetCharacterStream(value);
    CheckException(__result);
  }

  /* attribute nsIInputStream byteStream; */
  nsIInputStreamD  ByteStream(){
    nsIInputStream value;
    nsresult __result = inner.GetByteStream(&value);
    CheckException(__result);
    return new nsIInputStreamD(value);
  }
  void ByteStream(nsIInputStreamD  aByteStream){
    nsIInputStream value;
    nsresult __result = inner.SetByteStream(value);
    CheckException(__result);
  }
  ...
  wchar[] StringData(){
    ...
    nsresult __result = inner.GetStringData(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void StringData(wchar[] aStringData){
    scope auto value = new AString(aStringData);
    nsresult __result = inner.SetStringData(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  void SystemId(wchar[] aSystemId){
    scope auto value = new AString(aSystemId);
    nsresult __result = inner.SetSystemId(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  void PublicId(wchar[] aPublicId){
    scope auto value = new AString(aPublicId);
    nsresult __result = inner.SetPublicId(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  void BaseURI(wchar[] aBaseURI){
    scope auto value = new AString(aBaseURI);
    nsresult __result = inner.SetBaseURI(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  PRBool CertifiedText(){
    PRBool value;
    nsresult __result = inner.GetCertifiedText(&value);
    CheckException(__result);
    return value;
  }
  void CertifiedText(PRBool aCertifiedText){
    nsresult __result = inner.SetCertifiedText(aCertifiedText);
    CheckException(__result);
  }
