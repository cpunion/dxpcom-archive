...
module mozilla.dxpcom.nsIPrefServiceD;
...
/* starting wrapper class:    nsIPrefService */
/**
 ...
 * @status FROZEN
 */
class nsIPrefServiceD : public nsISupportsD {

  static const nsIID IID = NS_IPREFSERVICE_IID;


  alias nsIPrefService InnerType;

  this(nsIPrefService intr){
    super(intr);
    this.inner = intr;
  }

  nsIPrefService opCast() {
    return inner;
  }

  void opAssign(nsIPrefService value) {
    inner = value;
  }
