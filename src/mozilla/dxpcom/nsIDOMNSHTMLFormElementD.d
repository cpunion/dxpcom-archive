...
module mozilla.dxpcom.nsIDOMNSHTMLFormElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLFormElement;


public import mozilla.dxpcom.nsIDOMNSHTMLFormElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLFormElement */
class nsIDOMNSHTMLFormElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLFORMELEMENT_IID;


  alias nsIDOMNSHTMLFormElement InnerType;

  this(nsIDOMNSHTMLFormElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLFormElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLFormElement value) {
    inner = value;
  }
