...
module mozilla.dxpcom.nsIHTMLInlineTableEditorD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIHTMLInlineTableEditor;


public import mozilla.dxpcom.nsIHTMLInlineTableEditorD;
...
/* starting wrapper class:    nsIHTMLInlineTableEditor */
class nsIHTMLInlineTableEditorD : public nsISupportsD {

  static const nsIID IID = NS_IHTMLINLINETABLEEDITOR_IID;


  alias nsIHTMLInlineTableEditor InnerType;

  this(nsIHTMLInlineTableEditor intr){
    super(intr);
    this.inner = intr;
  }

  nsIHTMLInlineTableEditor opCast() {
    return inner;
  }

  void opAssign(nsIHTMLInlineTableEditor value) {
    inner = value;
  }
  ...
  PRBool InlineTableEditingEnabled(){
    PRBool value;
    nsresult __result = inner.GetInlineTableEditingEnabled(&value);
    CheckException(__result);
    return value;
  }
  void InlineTableEditingEnabled(PRBool aInlineTableEditingEnabled){
    nsresult __result = inner.SetInlineTableEditingEnabled(aInlineTableEditingEnabled);
    CheckException(__result);
  }
  ...
  void ShowInlineTableEditingUI(nsIDOMElementD aCell){
    nsresult __result = inner.ShowInlineTableEditingUI(aCell ? cast(nsIDOMElement)aCell : null);
    CheckException(__result);
  }
  ...
  void HideInlineTableEditingUI(){
    nsresult __result = inner.HideInlineTableEditingUI();
    CheckException(__result);
  }
  ...
  void DoInlineTableEditingAction(nsIDOMElementD aUIAnonymousElement){
    nsresult __result = inner.DoInlineTableEditingAction(aUIAnonymousElement ? cast(nsIDOMElement)aUIAnonymousElement : null);
    CheckException(__result);
  }
  ...
  void RefreshInlineTableEditingUI(){
    nsresult __result = inner.RefreshInlineTableEditingUI();
    CheckException(__result);
  }

private:
  nsIHTMLInlineTableEditor inner;
