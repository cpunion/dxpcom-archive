...
module mozilla.dxpcom.nsIDOMCSSValueD;
...
/* starting wrapper class:    nsIDOMCSSValue */
class nsIDOMCSSValueD : public nsISupportsD {

  static const nsIID IID = NS_IDOMCSSVALUE_IID;


  alias nsIDOMCSSValue InnerType;

  this(nsIDOMCSSValue intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMCSSValue opCast() {
    return inner;
  }

  void opAssign(nsIDOMCSSValue value) {
    inner = value;
  }
 ...
 */
  ...
  PRUint16 CssValueType(){
    PRUint16 value;
    nsresult __result = inner.GetCssValueType(&value);
    CheckException(__result);
    return value;
  }

private:
  nsIDOMCSSValue inner;
