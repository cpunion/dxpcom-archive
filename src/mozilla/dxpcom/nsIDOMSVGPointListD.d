...
module mozilla.dxpcom.nsIDOMSVGPointListD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGPointList;


public import mozilla.dxpcom.nsIDOMSVGPointListD;
...
/* starting wrapper class:    nsIDOMSVGPointList */
class nsIDOMSVGPointListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGPOINTLIST_IID;


  alias nsIDOMSVGPointList InnerType;

  this(nsIDOMSVGPointList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGPointList opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGPointList value) {
    inner = value;
  }
  ...
  nsIDOMSVGPointD  Initialize(nsIDOMSVGPointD newItem){
    nsIDOMSVGPoint _retval;
    nsresult __result = inner.Initialize(newItem ? cast(nsIDOMSVGPoint)newItem : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPointD(_retval);
  }

  /* nsIDOMSVGPoint getItem (in unsigned long index); */
  nsIDOMSVGPointD  GetItem(PRUint32 index){
    nsIDOMSVGPoint _retval;
  ...
  nsIDOMSVGPointD  InsertItemBefore(nsIDOMSVGPointD newItem, PRUint32 index){
    nsIDOMSVGPoint _retval;
    nsresult __result = inner.InsertItemBefore(newItem ? cast(nsIDOMSVGPoint)newItem : null, index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPointD(_retval);
  }

  /* nsIDOMSVGPoint replaceItem (in nsIDOMSVGPoint newItem, in unsigned long index); */
  nsIDOMSVGPointD  ReplaceItem(nsIDOMSVGPointD newItem, PRUint32 index){
    nsIDOMSVGPoint _retval;
    nsresult __result = inner.ReplaceItem(newItem ? cast(nsIDOMSVGPoint)newItem : null, index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPointD(_retval);
  }

  /* nsIDOMSVGPoint removeItem (in unsigned long index); */
  nsIDOMSVGPointD  RemoveItem(PRUint32 index){
    nsIDOMSVGPoint _retval;
  ...
  nsIDOMSVGPointD  AppendItem(nsIDOMSVGPointD newItem){
    nsIDOMSVGPoint _retval;
    nsresult __result = inner.AppendItem(newItem ? cast(nsIDOMSVGPoint)newItem : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPointD(_retval);
  }

private:
  nsIDOMSVGPointList inner;
