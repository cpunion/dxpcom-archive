...
module mozilla.dxpcom.nsIDOMWindowCollectionD;
...
/* starting wrapper class:    nsIDOMWindowCollection */
class nsIDOMWindowCollectionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMWINDOWCOLLECTION_IID;


  alias nsIDOMWindowCollection InnerType;

  this(nsIDOMWindowCollection intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMWindowCollection opCast() {
    return inner;
  }

  void opAssign(nsIDOMWindowCollection value) {
    inner = value;
  }
...
/**
  ...
  nsIDOMWindowD  Item(PRUint32 index){
  ...
  nsIDOMWindowD  NamedItem(wchar[] name){
