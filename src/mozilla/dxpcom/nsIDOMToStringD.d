...
module mozilla.dxpcom.nsIDOMToStringD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMToString;


public import mozilla.dxpcom.nsIDOMToStringD;
...
/* starting wrapper class:    nsIDOMToString */
/**
 ...
 */
class nsIDOMToStringD : public nsISupportsD {

  static const nsIID IID = NS_IDOMTOSTRING_IID;


  alias nsIDOMToString InnerType;

  this(nsIDOMToString intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMToString opCast() {
    return inner;
  }

  void opAssign(nsIDOMToString value) {
    inner = value;
  }
