...
module mozilla.dxpcom.nsIDOMStyleSheetListD;
...
/* starting wrapper class:    nsIDOMStyleSheetList */
class nsIDOMStyleSheetListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSTYLESHEETLIST_IID;


  alias nsIDOMStyleSheetList InnerType;

  this(nsIDOMStyleSheetList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMStyleSheetList opCast() {
    return inner;
  }

  void opAssign(nsIDOMStyleSheetList value) {
    inner = value;
  }
 ...
 */
  ...
  nsIDOMStyleSheetD  Item(PRUint32 index){
    nsIDOMStyleSheet _retval;
    nsresult __result = inner.Item(index, &_retval);
    CheckException(__result);
    return new nsIDOMStyleSheetD(_retval);
  }

private:
  nsIDOMStyleSheetList inner;
