/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIDOMDOMErrorHandler.idl
 */

module mozilla.dxpcom.nsIDOMDOMErrorHandlerD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMDOMErrorHandler;


public import mozilla.dxpcom.nsIDOMDOMErrorHandlerD;
...
/* starting wrapper class:    nsIDOMDOMErrorHandler */
/**
 ...
 */
class nsIDOMDOMErrorHandlerD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOMERRORHANDLER_IID;


  alias nsIDOMDOMErrorHandler InnerType;

  this(nsIDOMDOMErrorHandler intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDOMErrorHandler opCast() {
    return inner;
  }

  void opAssign(nsIDOMDOMErrorHandler value) {
    inner = value;
  }

  /* boolean handleError (in nsIDOMDOMError error); */
  PRBool HandleError(nsIDOMDOMErrorD error){
    PRBool _retval;
    nsresult __result = inner.HandleError(error ? cast(nsIDOMDOMError)error : null, &_retval);
    CheckException(__result);
    return _retval;
  }

private:
  nsIDOMDOMErrorHandler inner;
