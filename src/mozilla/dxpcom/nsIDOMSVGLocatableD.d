...
module mozilla.dxpcom.nsIDOMSVGLocatableD;
...
/* starting wrapper class:    nsIDOMSVGLocatable */
class nsIDOMSVGLocatableD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGLOCATABLE_IID;


  alias nsIDOMSVGLocatable InnerType;

  this(nsIDOMSVGLocatable intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGLocatable opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGLocatable value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGElement nearestViewportElement; */
  nsIDOMSVGElementD  NearestViewportElement(){
    nsIDOMSVGElement value;
    nsresult __result = inner.GetNearestViewportElement(&value);
    CheckException(__result);
    return new nsIDOMSVGElementD(value);
  }

  /* readonly attribute nsIDOMSVGElement farthestViewportElement; */
  nsIDOMSVGElementD  FarthestViewportElement(){
    nsIDOMSVGElement value;
    nsresult __result = inner.GetFarthestViewportElement(&value);
    CheckException(__result);
    return new nsIDOMSVGElementD(value);
  }

  /* nsIDOMSVGRect getBBox (); */
  nsIDOMSVGRectD  GetBBox(){
    nsIDOMSVGRect _retval;
    nsresult __result = inner.GetBBox(&_retval);
    CheckException(__result);
    return new nsIDOMSVGRectD(_retval);
  }

  /* nsIDOMSVGMatrix getCTM (); */
  nsIDOMSVGMatrixD  GetCTM(){
    nsIDOMSVGMatrix _retval;
    nsresult __result = inner.GetCTM(&_retval);
    CheckException(__result);
    return new nsIDOMSVGMatrixD(_retval);
  }

  /* nsIDOMSVGMatrix getScreenCTM (); */
  nsIDOMSVGMatrixD  GetScreenCTM(){
    nsIDOMSVGMatrix _retval;
    nsresult __result = inner.GetScreenCTM(&_retval);
    CheckException(__result);
    return new nsIDOMSVGMatrixD(_retval);
  }

  /* nsIDOMSVGMatrix getTransformToElement (in nsIDOMSVGElement element); */
  nsIDOMSVGMatrixD  GetTransformToElement(nsIDOMSVGElementD element){
    nsIDOMSVGMatrix _retval;
    nsresult __result = inner.GetTransformToElement(element ? cast(nsIDOMSVGElement)element : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGMatrixD(_retval);
  }

private:
  nsIDOMSVGLocatable inner;
