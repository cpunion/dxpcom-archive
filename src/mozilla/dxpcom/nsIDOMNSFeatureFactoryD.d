...
module mozilla.dxpcom.nsIDOMNSFeatureFactoryD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSFeatureFactory;


public import mozilla.dxpcom.nsIDOMNSFeatureFactoryD;
...
/* starting wrapper class:    nsIDOMNSFeatureFactory */
class nsIDOMNSFeatureFactoryD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSFEATUREFACTORY_IID;


  alias nsIDOMNSFeatureFactory InnerType;

  this(nsIDOMNSFeatureFactory intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSFeatureFactory opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSFeatureFactory value) {
    inner = value;
  }
  ...
  PRBool HasFeature(nsISupportsD object, wchar[] feature, wchar[] version_){
    scope auto _feature = new AString(feature);
    scope auto _version = new AString(version_);
    PRBool _retval;
    nsresult __result = inner.HasFeature(object ? cast(nsISupports)object : null, cast(nsAString*)_feature, cast(nsAString*)_version, &_retval);
  ...
  nsISupportsD  GetFeature(nsISupportsD object, wchar[] feature, wchar[] version_){
    scope auto _feature = new AString(feature);
    scope auto _version = new AString(version_);
    nsISupports _retval;
    nsresult __result = inner.GetFeature(object ? cast(nsISupports)object : null, cast(nsAString*)_feature, cast(nsAString*)_version, &_retval);
    CheckException(__result);
    return new nsISupportsD(_retval);
  }

private:
  nsIDOMNSFeatureFactory inner;
