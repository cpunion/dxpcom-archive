...
module mozilla.dxpcom.nsIWebBrowserPersistD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIWebBrowserPersist;


public import mozilla.dxpcom.nsIWebBrowserPersistD;
...
/* starting wrapper class:    nsIWebBrowserPersist */
/**
 * Interface for persisting DOM documents and URIs to local or remote storage.
 *
 * @status UNDER_REVIEW
 */
class nsIWebBrowserPersistD : public nsICancelableD {

  static const nsIID IID = NS_IWEBBROWSERPERSIST_IID;


  alias nsIWebBrowserPersist InnerType;

  this(nsIWebBrowserPersist intr){
    super(intr);
    this.inner = intr;
  }

  nsIWebBrowserPersist opCast() {
    return inner;
  }

  void opAssign(nsIWebBrowserPersist value) {
    inner = value;
  }
  ...
  PRUint32 PersistFlags(){
    PRUint32 value;
    nsresult __result = inner.GetPersistFlags(&value);
    CheckException(__result);
    return value;
  }
  void PersistFlags(PRUint32 aPersistFlags){
    nsresult __result = inner.SetPersistFlags(aPersistFlags);
    CheckException(__result);
  }
  ...
  PRUint32 CurrentState(){
    PRUint32 value;
    nsresult __result = inner.GetCurrentState(&value);
    CheckException(__result);
    return value;
  }
  ...
  nsIWebProgressListenerD  ProgressListener(){
    nsIWebProgressListener value;
    nsresult __result = inner.GetProgressListener(&value);
    CheckException(__result);
    return new nsIWebProgressListenerD(value);
  }
  void ProgressListener(nsIWebProgressListenerD  aProgressListener){
    nsIWebProgressListener value;
    nsresult __result = inner.SetProgressListener(value);
    CheckException(__result);
  }
  ...
  void SaveURI(nsIURID aURI, nsISupportsD aCacheKey, nsIURID aReferrer, nsIInputStreamD aPostData, char*aExtraHeaders, nsISupportsD aFile){
    nsresult __result = inner.SaveURI(aURI ? cast(nsIURI)aURI : null, aCacheKey ? cast(nsISupports)aCacheKey : null, aReferrer ? cast(nsIURI)aReferrer : null, aPostData ? cast(nsIInputStream)aPostData : null, aExtraHeaders, aFile ? cast(nsISupports)aFile : null);
    CheckException(__result);
  }
  ...
  void SaveChannel(nsIChannelD aChannel, nsISupportsD aFile){
    nsresult __result = inner.SaveChannel(aChannel ? cast(nsIChannel)aChannel : null, aFile ? cast(nsISupports)aFile : null);
    CheckException(__result);
  }
  ...
  void SaveDocument(nsIDOMDocumentD aDocument, nsISupportsD aFile, nsISupportsD aDataPath, char*aOutputContentType, PRUint32 aEncodingFlags, PRUint32 aWrapColumn){
    nsresult __result = inner.SaveDocument(aDocument ? cast(nsIDOMDocument)aDocument : null, aFile ? cast(nsISupports)aFile : null, aDataPath ? cast(nsISupports)aDataPath : null, aOutputContentType, aEncodingFlags, aWrapColumn);
    CheckException(__result);
  }
  ...
  /* void cancelSave (); */
  void CancelSave(){
    nsresult __result = inner.CancelSave();
    CheckException(__result);
  }

private:
  nsIWebBrowserPersist inner;
