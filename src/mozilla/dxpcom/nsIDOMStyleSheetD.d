...
module mozilla.dxpcom.nsIDOMStyleSheetD;
...
/* starting wrapper class:    nsIDOMStyleSheet */
class nsIDOMStyleSheetD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSTYLESHEET_IID;


  alias nsIDOMStyleSheet InnerType;

  this(nsIDOMStyleSheet intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMStyleSheet opCast() {
    return inner;
  }

  void opAssign(nsIDOMStyleSheet value) {
    inner = value;
  }
 ...
 */
  ...
  nsIDOMNodeD  OwnerNode(){
    nsIDOMNode value;
    nsresult __result = inner.GetOwnerNode(&value);
    CheckException(__result);
    return new nsIDOMNodeD(value);
  }

  /* readonly attribute nsIDOMStyleSheet parentStyleSheet; */
  nsIDOMStyleSheetD  ParentStyleSheet(){
    nsIDOMStyleSheet value;
    nsresult __result = inner.GetParentStyleSheet(&value);
    CheckException(__result);
    return new nsIDOMStyleSheetD(value);
  }
