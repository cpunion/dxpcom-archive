...
module mozilla.dxpcom.nsIDOMSVGRectD;
...
/* starting wrapper class:    nsIDOMSVGRect */
class nsIDOMSVGRectD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGRECT_IID;


  alias nsIDOMSVGRect InnerType;

  this(nsIDOMSVGRect intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGRect opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGRect value) {
    inner = value;
  }
