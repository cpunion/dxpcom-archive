...
module mozilla.dxpcom.nsIDOMTreeWalkerD;
...
/* starting wrapper class:    nsIDOMTreeWalker */
class nsIDOMTreeWalkerD : public nsISupportsD {

  static const nsIID IID = NS_IDOMTREEWALKER_IID;


  alias nsIDOMTreeWalker InnerType;

  this(nsIDOMTreeWalker intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMTreeWalker opCast() {
    return inner;
  }

  void opAssign(nsIDOMTreeWalker value) {
    inner = value;
  }
  ...
  nsIDOMNodeFilterD  Filter(){
    nsIDOMNodeFilter value;
    nsresult __result = inner.GetFilter(&value);
    CheckException(__result);
    return new nsIDOMNodeFilterD(value);
  }

  /* readonly attribute boolean expandEntityReferences; */
  PRBool ExpandEntityReferences(){
    PRBool value;
    nsresult __result = inner.GetExpandEntityReferences(&value);
    CheckException(__result);
    return value;
  }

  /* attribute nsIDOMNode currentNode; */
  nsIDOMNodeD  CurrentNode(){
    nsIDOMNode value;
    nsresult __result = inner.GetCurrentNode(&value);
    CheckException(__result);
    return new nsIDOMNodeD(value);
  }
  void CurrentNode(nsIDOMNodeD  aCurrentNode){
    nsIDOMNode value;
    nsresult __result = inner.SetCurrentNode(value);
    CheckException(__result);
  }
  ...
  nsIDOMNodeD  ParentNode(){
    nsIDOMNode _retval;
    nsresult __result = inner.ParentNode(&_retval);
    CheckException(__result);
  ...
  nsIDOMNodeD  FirstChild(){
    nsIDOMNode _retval;
    nsresult __result = inner.FirstChild(&_retval);
    CheckException(__result);
    return new nsIDOMNodeD(_retval);
  }
  ...
  nsIDOMNodeD  LastChild(){
    nsIDOMNode _retval;
    nsresult __result = inner.LastChild(&_retval);
    CheckException(__result);
    return new nsIDOMNodeD(_retval);
  }
  ...
  nsIDOMNodeD  PreviousSibling(){
    nsIDOMNode _retval;
    nsresult __result = inner.PreviousSibling(&_retval);
    CheckException(__result);
    return new nsIDOMNodeD(_retval);
  }
  ...
  nsIDOMNodeD  NextSibling(){
    nsIDOMNode _retval;
    nsresult __result = inner.NextSibling(&_retval);
    CheckException(__result);
    return new nsIDOMNodeD(_retval);
  }

  /* nsIDOMNode previousNode (); */
  nsIDOMNodeD  PreviousNode(){
    nsIDOMNode _retval;
    nsresult __result = inner.PreviousNode(&_retval);
    CheckException(__result);
    return new nsIDOMNodeD(_retval);
  }

  /* nsIDOMNode nextNode (); */
  nsIDOMNodeD  NextNode(){
    nsIDOMNode _retval;
    nsresult __result = inner.NextNode(&_retval);
    CheckException(__result);
    return new nsIDOMNodeD(_retval);
  }

private:
  nsIDOMTreeWalker inner;
