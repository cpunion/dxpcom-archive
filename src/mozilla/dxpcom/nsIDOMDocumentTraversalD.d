...
module mozilla.dxpcom.nsIDOMDocumentTraversalD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMDocumentTraversal;


public import mozilla.dxpcom.nsIDOMDocumentTraversalD;
...
public import mozilla.xpcom.nsIDOMNodeIterator;

public import mozilla.dxpcom.nsIDOMNodeIteratorD;
...
/* starting wrapper class:    nsIDOMDocumentTraversal */
class nsIDOMDocumentTraversalD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOCUMENTTRAVERSAL_IID;


  alias nsIDOMDocumentTraversal InnerType;

  this(nsIDOMDocumentTraversal intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDocumentTraversal opCast() {
    return inner;
  }

  void opAssign(nsIDOMDocumentTraversal value) {
    inner = value;
  }
  ...
  nsIDOMNodeIteratorD  CreateNodeIterator(nsIDOMNodeD root, PRUint32 whatToShow, nsIDOMNodeFilterD filter, PRBool entityReferenceExpansion){
    nsIDOMNodeIterator _retval;
    nsresult __result = inner.CreateNodeIterator(root ? cast(nsIDOMNode)root : null, whatToShow, filter ? cast(nsIDOMNodeFilter)filter : null, entityReferenceExpansion, &_retval);
    CheckException(__result);
    return new nsIDOMNodeIteratorD(_retval);
  }
  ...
  nsIDOMTreeWalkerD  CreateTreeWalker(nsIDOMNodeD root, PRUint32 whatToShow, nsIDOMNodeFilterD filter, PRBool entityReferenceExpansion){
    nsIDOMTreeWalker _retval;
    nsresult __result = inner.CreateTreeWalker(root ? cast(nsIDOMNode)root : null, whatToShow, filter ? cast(nsIDOMNodeFilter)filter : null, entityReferenceExpansion, &_retval);
    CheckException(__result);
    return new nsIDOMTreeWalkerD(_retval);
  }

private:
  nsIDOMDocumentTraversal inner;
