...
module mozilla.dxpcom.nsIDOMLSSerializerD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMLSSerializer;


public import mozilla.dxpcom.nsIDOMLSSerializerD;
...
public import mozilla.xpcom.nsIDOMLSOutput;

public import mozilla.dxpcom.nsIDOMLSOutputD;
...
/* starting wrapper class:    nsIDOMLSSerializer */
class nsIDOMLSSerializerD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLSSERIALIZER_IID;


  alias nsIDOMLSSerializer InnerType;

  this(nsIDOMLSSerializer intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLSSerializer opCast() {
    return inner;
  }

  void opAssign(nsIDOMLSSerializer value) {
    inner = value;
  }
  ...
  wchar[] NewLine(){
    ...
    nsresult __result = inner.GetNewLine(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void NewLine(wchar[] aNewLine){
    scope auto value = new AString(aNewLine);
    nsresult __result = inner.SetNewLine(cast(nsAString*)value);
    CheckException(__result);
  }

  /* attribute nsIDOMLSSerializerFilter filter; */
  nsIDOMLSSerializerFilterD  Filter(){
    nsIDOMLSSerializerFilter value;
    nsresult __result = inner.GetFilter(&value);
    CheckException(__result);
    return new nsIDOMLSSerializerFilterD(value);
  }
  void Filter(nsIDOMLSSerializerFilterD  aFilter){
    nsIDOMLSSerializerFilter value;
  ...
  PRBool Write(nsIDOMNodeD nodeArg, nsIDOMLSOutputD destination){
    PRBool _retval;
    nsresult __result = inner.Write(nodeArg ? cast(nsIDOMNode)nodeArg : null, destination ? cast(nsIDOMLSOutput)destination : null, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* boolean writeToURI (in nsIDOMNode nodeArg, in DOMString uri)  raises (LSException); */
  PRBool WriteToURI(nsIDOMNodeD nodeArg, wchar[] uri){
    scope auto _uri = new AString(uri);
    PRBool _retval;
    nsresult __result = inner.WriteToURI(nodeArg ? cast(nsIDOMNode)nodeArg : null, cast(nsAString*)_uri, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* DOMString writeToString (in nsIDOMNode nodeArg)  raises (DOMException, LSException); */
  wchar[] WriteToString(nsIDOMNodeD nodeArg){
    scope auto _retval = new AString;
    nsresult __result = inner.WriteToString(nodeArg ? cast(nsIDOMNode)nodeArg : null, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }

private:
  nsIDOMLSSerializer inner;
