...
module mozilla.dxpcom.nsIDOMSVGAnimatedPathDataD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGAnimatedPathData;


public import mozilla.dxpcom.nsIDOMSVGAnimatedPathDataD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedPathData */
class nsIDOMSVGAnimatedPathDataD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDPATHDATA_IID;


  alias nsIDOMSVGAnimatedPathData InnerType;

  this(nsIDOMSVGAnimatedPathData intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedPathData opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedPathData value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGPathSegList pathSegList; */
  nsIDOMSVGPathSegListD  PathSegList(){
    nsIDOMSVGPathSegList value;
    nsresult __result = inner.GetPathSegList(&value);
    CheckException(__result);
    return new nsIDOMSVGPathSegListD(value);
  }

  /* readonly attribute nsIDOMSVGPathSegList normalizedPathSegList; */
  nsIDOMSVGPathSegListD  NormalizedPathSegList(){
    nsIDOMSVGPathSegList value;
    nsresult __result = inner.GetNormalizedPathSegList(&value);
    CheckException(__result);
    return new nsIDOMSVGPathSegListD(value);
  }

  /* readonly attribute nsIDOMSVGPathSegList animatedPathSegList; */
  nsIDOMSVGPathSegListD  AnimatedPathSegList(){
    nsIDOMSVGPathSegList value;
    nsresult __result = inner.GetAnimatedPathSegList(&value);
    CheckException(__result);
    return new nsIDOMSVGPathSegListD(value);
  }

  /* readonly attribute nsIDOMSVGPathSegList animatedNormalizedPathSegList; */
  nsIDOMSVGPathSegListD  AnimatedNormalizedPathSegList(){
    nsIDOMSVGPathSegList value;
    nsresult __result = inner.GetAnimatedNormalizedPathSegList(&value);
    CheckException(__result);
    return new nsIDOMSVGPathSegListD(value);
  }

private:
  nsIDOMSVGAnimatedPathData inner;
