...
module mozilla.dxpcom.nsIContentPolicyD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIContentPolicy;


public import mozilla.dxpcom.nsIContentPolicyD;
...
/* starting wrapper class:    nsIContentPolicy */
/**
 ...
 */
class nsIContentPolicyD : public nsISupportsD {

  static const nsIID IID = NS_ICONTENTPOLICY_IID;


  alias nsIContentPolicy InnerType;

  this(nsIContentPolicy intr){
    super(intr);
    this.inner = intr;
  }

  nsIContentPolicy opCast() {
    return inner;
  }

  void opAssign(nsIContentPolicy value) {
    inner = value;
  }
  ...
  PRInt16 ShouldLoad(PRUint32 aContentType, nsIURID aContentLocation, nsIURID aRequestOrigin, nsISupportsD aContext, char[] aMimeTypeGuess, nsISupportsD aExtra){
    scope auto _aMimeTypeGuess = new ACString(aMimeTypeGuess);
    PRInt16 _retval;
    nsresult __result = inner.ShouldLoad(aContentType, aContentLocation ? cast(nsIURI)aContentLocation : null, aRequestOrigin ? cast(nsIURI)aRequestOrigin : null, aContext ? cast(nsISupports)aContext : null, cast(nsACString*)_aMimeTypeGuess, aExtra ? cast(nsISupports)aExtra : null, &_retval);
  ...
  PRInt16 ShouldProcess(PRUint32 aContentType, nsIURID aContentLocation, nsIURID aRequestOrigin, nsISupportsD aContext, char[] aMimeType, nsISupportsD aExtra){
    scope auto _aMimeType = new ACString(aMimeType);
    PRInt16 _retval;
    nsresult __result = inner.ShouldProcess(aContentType, aContentLocation ? cast(nsIURI)aContentLocation : null, aRequestOrigin ? cast(nsIURI)aRequestOrigin : null, aContext ? cast(nsISupports)aContext : null, cast(nsACString*)_aMimeType, aExtra ? cast(nsISupports)aExtra : null, &_retval);
    CheckException(__result);
    return _retval;
  }

private:
  nsIContentPolicy inner;
