...
module mozilla.dxpcom.nsIDOMAbstractViewD;
...
/* starting wrapper class:    nsIDOMAbstractView */
class nsIDOMAbstractViewD : public nsISupportsD {

  static const nsIID IID = NS_IDOMABSTRACTVIEW_IID;


  alias nsIDOMAbstractView InnerType;

  this(nsIDOMAbstractView intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMAbstractView opCast() {
    return inner;
  }

  void opAssign(nsIDOMAbstractView value) {
    inner = value;
  }
 ...
 */
  ...
  nsIDOMDocumentViewD  Document(){
    nsIDOMDocumentView value;
    nsresult __result = inner.GetDocument(&value);
    CheckException(__result);
    return new nsIDOMDocumentViewD(value);
  }

private:
  nsIDOMAbstractView inner;
