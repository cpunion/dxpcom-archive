...
module mozilla.dxpcom.nsIDOMDocumentRangeD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMDocumentRange;


public import mozilla.dxpcom.nsIDOMDocumentRangeD;
...
/* starting wrapper class:    nsIDOMDocumentRange */
/**
 ...
 * @status FROZEN
 */
class nsIDOMDocumentRangeD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOCUMENTRANGE_IID;


  alias nsIDOMDocumentRange InnerType;

  this(nsIDOMDocumentRange intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDocumentRange opCast() {
    return inner;
  }

  void opAssign(nsIDOMDocumentRange value) {
    inner = value;
  }

  /* nsIDOMRange createRange (); */
  nsIDOMRangeD  CreateRange(){
    nsIDOMRange _retval;
    nsresult __result = inner.CreateRange(&_retval);
    CheckException(__result);
    return new nsIDOMRangeD(_retval);
  }

private:
  nsIDOMDocumentRange inner;
