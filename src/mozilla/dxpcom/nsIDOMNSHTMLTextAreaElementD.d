...
module mozilla.dxpcom.nsIDOMNSHTMLTextAreaElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLTextAreaElement;


public import mozilla.dxpcom.nsIDOMNSHTMLTextAreaElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLTextAreaElement */
class nsIDOMNSHTMLTextAreaElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLTEXTAREAELEMENT_IID;


  alias nsIDOMNSHTMLTextAreaElement InnerType;

  this(nsIDOMNSHTMLTextAreaElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLTextAreaElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLTextAreaElement value) {
    inner = value;
  }
...
private:
  nsIDOMNSHTMLTextAreaElement inner;
