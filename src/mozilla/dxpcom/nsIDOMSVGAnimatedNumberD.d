...
module mozilla.dxpcom.nsIDOMSVGAnimatedNumberD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedNumber */
class nsIDOMSVGAnimatedNumberD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDNUMBER_IID;


  alias nsIDOMSVGAnimatedNumber InnerType;

  this(nsIDOMSVGAnimatedNumber intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedNumber opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedNumber value) {
    inner = value;
  }
