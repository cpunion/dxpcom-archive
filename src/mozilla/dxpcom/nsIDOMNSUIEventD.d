...
module mozilla.dxpcom.nsIDOMNSUIEventD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSUIEvent;


public import mozilla.dxpcom.nsIDOMNSUIEventD;
...
/* starting wrapper class:    nsIDOMNSUIEvent */
class nsIDOMNSUIEventD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSUIEVENT_IID;


  alias nsIDOMNSUIEvent InnerType;

  this(nsIDOMNSUIEvent intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSUIEvent opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSUIEvent value) {
    inner = value;
  }
  ...
  PRBool GetPreventDefault(){
    PRBool _retval;
    nsresult __result = inner.GetPreventDefault(&_retval);
  ...
  PRInt32 LayerX(){
    PRInt32 value;
    nsresult __result = inner.GetLayerX(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 LayerY(){
    PRInt32 value;
    nsresult __result = inner.GetLayerY(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 PageX(){
    PRInt32 value;
    nsresult __result = inner.GetPageX(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 PageY(){
    PRInt32 value;
    nsresult __result = inner.GetPageY(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRUint32 Which(){
    PRUint32 value;
    nsresult __result = inner.GetWhich(&value);
    CheckException(__result);
    return value;
  }

  /* readonly attribute nsIDOMNode rangeParent; */
  nsIDOMNodeD  RangeParent(){
    nsIDOMNode value;
    nsresult __result = inner.GetRangeParent(&value);
    CheckException(__result);
  ...
  PRInt32 RangeOffset(){
    PRInt32 value;
    nsresult __result = inner.GetRangeOffset(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRBool CancelBubble(){
    PRBool value;
    nsresult __result = inner.GetCancelBubble(&value);
    CheckException(__result);
    return value;
  }
  void CancelBubble(PRBool aCancelBubble){
    nsresult __result = inner.SetCancelBubble(aCancelBubble);
    CheckException(__result);
  }
  ...
  PRBool IsChar(){
    PRBool value;
    nsresult __result = inner.GetIsChar(&value);
    CheckException(__result);
    return value;
  }

private:
  nsIDOMNSUIEvent inner;
