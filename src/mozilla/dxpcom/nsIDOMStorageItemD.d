...
module mozilla.dxpcom.nsIDOMStorageItemD;
...
/* starting wrapper class:    nsIDOMStorageItem */
/**
 ...
 */
class nsIDOMStorageItemD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSTORAGEITEM_IID;


  alias nsIDOMStorageItem InnerType;

  this(nsIDOMStorageItem intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMStorageItem opCast() {
    return inner;
  }

  void opAssign(nsIDOMStorageItem value) {
    inner = value;
  }
  ...
  PRBool Secure(){
    PRBool value;
    nsresult __result = inner.GetSecure(&value);
    CheckException(__result);
    return value;
  }
  void Secure(PRBool aSecure){
    nsresult __result = inner.SetSecure(aSecure);
    CheckException(__result);
  }
