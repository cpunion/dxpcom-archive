...
module mozilla.dxpcom.nsIDOMSVGAngleD;
...
/* starting wrapper class:    nsIDOMSVGAngle */
/**
 ...
 *
 */
class nsIDOMSVGAngleD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANGLE_IID;


  alias nsIDOMSVGAngle InnerType;

  this(nsIDOMSVGAngle intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAngle opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAngle value) {
    inner = value;
  }
