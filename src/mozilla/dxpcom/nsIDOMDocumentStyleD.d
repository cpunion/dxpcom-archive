...
module mozilla.dxpcom.nsIDOMDocumentStyleD;
...
/* starting wrapper class:    nsIDOMDocumentStyle */
/**
 ...
 * @status FROZEN
 */
class nsIDOMDocumentStyleD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOCUMENTSTYLE_IID;


  alias nsIDOMDocumentStyle InnerType;

  this(nsIDOMDocumentStyle intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDocumentStyle opCast() {
    return inner;
  }

  void opAssign(nsIDOMDocumentStyle value) {
    inner = value;
  }

  /* readonly attribute nsIDOMStyleSheetList styleSheets; */
  nsIDOMStyleSheetListD  StyleSheets(){
    nsIDOMStyleSheetList value;
    nsresult __result = inner.GetStyleSheets(&value);
    CheckException(__result);
    return new nsIDOMStyleSheetListD(value);
  }

private:
  nsIDOMDocumentStyle inner;
