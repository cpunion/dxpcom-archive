...
module mozilla.dxpcom.nsIDOMHTMLCollectionD;
...
/* starting wrapper class:    nsIDOMHTMLCollection */
class nsIDOMHTMLCollectionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMHTMLCOLLECTION_IID;


  alias nsIDOMHTMLCollection InnerType;

  this(nsIDOMHTMLCollection intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMHTMLCollection opCast() {
    return inner;
  }

  void opAssign(nsIDOMHTMLCollection value) {
    inner = value;
  }
