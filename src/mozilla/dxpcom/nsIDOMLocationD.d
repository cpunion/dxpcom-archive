...
module mozilla.dxpcom.nsIDOMLocationD;
...
/* starting wrapper class:    nsIDOMLocation */
class nsIDOMLocationD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLOCATION_IID;


  alias nsIDOMLocation InnerType;

  this(nsIDOMLocation intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLocation opCast() {
    return inner;
  }

  void opAssign(nsIDOMLocation value) {
    inner = value;
  }
  ...
  wchar[] Hash(){
    ...
    nsresult __result = inner.GetHash(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Hash(wchar[] aHash){
    scope auto value = new AString(aHash);
    nsresult __result = inner.SetHash(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] Host(){
    scope auto value = new AString();
    nsresult __result = inner.GetHost(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Host(wchar[] aHost){
    scope auto value = new AString(aHost);
    nsresult __result = inner.SetHost(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] Hostname(){
    scope auto value = new AString();
    nsresult __result = inner.GetHostname(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Hostname(wchar[] aHostname){
    scope auto value = new AString(aHostname);
    nsresult __result = inner.SetHostname(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] Pathname(){
    scope auto value = new AString();
    nsresult __result = inner.GetPathname(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Pathname(wchar[] aPathname){
    scope auto value = new AString(aPathname);
    nsresult __result = inner.SetPathname(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] Port(){
    scope auto value = new AString();
    nsresult __result = inner.GetPort(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Port(wchar[] aPort){
    scope auto value = new AString(aPort);
    nsresult __result = inner.SetPort(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  void Protocol(wchar[] aProtocol){
    scope auto value = new AString(aProtocol);
    nsresult __result = inner.SetProtocol(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] Search(){
    scope auto value = new AString();
    nsresult __result = inner.GetSearch(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Search(wchar[] aSearch){
    scope auto value = new AString(aSearch);
    nsresult __result = inner.SetSearch(cast(nsAString*)value);
    CheckException(__result);
  }

  /* [noscript] void reload (in boolean forceget); */
  void Reload(PRBool forceget){
    nsresult __result = inner.Reload(forceget);
    CheckException(__result);
  }

  /* void replace (in DOMString url); */
  void Replace(wchar[] url){
    scope auto _url = new AString(url);
    nsresult __result = inner.Replace(cast(nsAString*)_url);
    CheckException(__result);
  }

  /* void assign (in DOMString url); */
  void Assign(wchar[] url){
    scope auto _url = new AString(url);
    nsresult __result = inner.Assign(cast(nsAString*)_url);
    CheckException(__result);
  }
