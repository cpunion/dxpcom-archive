...
module mozilla.dxpcom.nsIDOMSVGPresAspectRatioD;
...
public import mozilla.dxpcom.nsIDOMSVGPresAspectRatioD;
...
/* starting wrapper class:    nsIDOMSVGPreserveAspectRatio */
class nsIDOMSVGPreserveAspectRatioD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGPRESERVEASPECTRATIO_IID;


  alias nsIDOMSVGPreserveAspectRatio InnerType;

  this(nsIDOMSVGPreserveAspectRatio intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGPreserveAspectRatio opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGPreserveAspectRatio value) {
    inner = value;
  }
  ...
  PRUint16 Align(){
    PRUint16 value;
    nsresult __result = inner.GetAlign(&value);
    CheckException(__result);
    return value;
  }
  void Align(PRUint16 aAlign){
    nsresult __result = inner.SetAlign(aAlign);
    CheckException(__result);
  }
  ...
  PRUint16 MeetOrSlice(){
    PRUint16 value;
    nsresult __result = inner.GetMeetOrSlice(&value);
    CheckException(__result);
    return value;
  }
  void MeetOrSlice(PRUint16 aMeetOrSlice){
    nsresult __result = inner.SetMeetOrSlice(aMeetOrSlice);
    CheckException(__result);
  }

private:
  nsIDOMSVGPreserveAspectRatio inner;
