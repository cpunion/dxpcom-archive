...
module mozilla.dxpcom.nsIDOMMediaListD;
...
/* starting wrapper class:    nsIDOMMediaList */
class nsIDOMMediaListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMMEDIALIST_IID;


  alias nsIDOMMediaList InnerType;

  this(nsIDOMMediaList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMMediaList opCast() {
    return inner;
  }

  void opAssign(nsIDOMMediaList value) {
    inner = value;
  }
 ...
 */
  ...
  wchar[] MediaText(){
    ...
    nsresult __result = inner.GetMediaText(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void MediaText(wchar[] aMediaText){
    scope auto value = new AString(aMediaText);
    nsresult __result = inner.SetMediaText(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  wchar[] Item(PRUint32 index){
    scope auto _retval = new AString;
    nsresult __result = inner.Item(index, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }

  /* void deleteMedium (in DOMString oldMedium)  raises (DOMException); */
  void DeleteMedium(wchar[] oldMedium){
    scope auto _oldMedium = new AString(oldMedium);
    nsresult __result = inner.DeleteMedium(cast(nsAString*)_oldMedium);
    CheckException(__result);
  }

  /* void appendMedium (in DOMString newMedium)  raises (DOMException); */
  void AppendMedium(wchar[] newMedium){
    scope auto _newMedium = new AString(newMedium);
    nsresult __result = inner.AppendMedium(cast(nsAString*)_newMedium);
    CheckException(__result);
  }

private:
  nsIDOMMediaList inner;
