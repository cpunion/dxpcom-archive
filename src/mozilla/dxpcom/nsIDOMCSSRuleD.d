...
module mozilla.dxpcom.nsIDOMCSSRuleD;
...
/* starting wrapper class:    nsIDOMCSSRule */
class nsIDOMCSSRuleD : public nsISupportsD {

  static const nsIID IID = NS_IDOMCSSRULE_IID;


  alias nsIDOMCSSRule InnerType;

  this(nsIDOMCSSRule intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMCSSRule opCast() {
    return inner;
  }

  void opAssign(nsIDOMCSSRule value) {
    inner = value;
  }
 ...
 */
  ...
  wchar[] CssText(){
    ...
    nsresult __result = inner.GetCssText(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void CssText(wchar[] aCssText){
    scope auto value = new AString(aCssText);
    nsresult __result = inner.SetCssText(cast(nsAString*)value);
    CheckException(__result);
  }

  /* readonly attribute nsIDOMCSSStyleSheet parentStyleSheet; */
  nsIDOMCSSStyleSheetD  ParentStyleSheet(){
    nsIDOMCSSStyleSheet value;
    nsresult __result = inner.GetParentStyleSheet(&value);
    CheckException(__result);
    return new nsIDOMCSSStyleSheetD(value);
  }

  /* readonly attribute nsIDOMCSSRule parentRule; */
  nsIDOMCSSRuleD  ParentRule(){
    nsIDOMCSSRule value;
    nsresult __result = inner.GetParentRule(&value);
    CheckException(__result);
