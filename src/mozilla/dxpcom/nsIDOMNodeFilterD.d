...
module mozilla.dxpcom.nsIDOMNodeFilterD;
...
/* starting wrapper class:    nsIDOMNodeFilter */
class nsIDOMNodeFilterD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNODEFILTER_IID;


  alias nsIDOMNodeFilter InnerType;

  this(nsIDOMNodeFilter intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNodeFilter opCast() {
    return inner;
  }

  void opAssign(nsIDOMNodeFilter value) {
    inner = value;
  }
  ...
  PRInt16 AcceptNode(nsIDOMNodeD n){
    PRInt16 _retval;
    nsresult __result = inner.AcceptNode(n ? cast(nsIDOMNode)n : null, &_retval);
    CheckException(__result);
    return _retval;
  }

private:
  nsIDOMNodeFilter inner;
