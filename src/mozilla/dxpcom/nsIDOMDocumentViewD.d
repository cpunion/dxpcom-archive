...
module mozilla.dxpcom.nsIDOMDocumentViewD;
...
/* starting wrapper class:    nsIDOMDocumentView */
class nsIDOMDocumentViewD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOCUMENTVIEW_IID;


  alias nsIDOMDocumentView InnerType;

  this(nsIDOMDocumentView intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDocumentView opCast() {
    return inner;
  }

  void opAssign(nsIDOMDocumentView value) {
    inner = value;
  }
 ...
 */
  ...
  nsIDOMAbstractViewD  DefaultView(){
    nsIDOMAbstractView value;
    nsresult __result = inner.GetDefaultView(&value);
    CheckException(__result);
    return new nsIDOMAbstractViewD(value);
  }

private:
  nsIDOMDocumentView inner;
