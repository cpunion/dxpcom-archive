...
module mozilla.dxpcom.nsIDOMSVGAnimPresAspRatioD;
...
public import mozilla.dxpcom.nsIDOMSVGAnimPresAspRatioD;
...
public import mozilla.xpcom.nsIDOMSVGPresAspectRatio;

import mozilla.dxpcom.nsIDOMSVGPresAspectRatioD;


/* starting wrapper class:    nsIDOMSVGAnimatedPreserveAspectRatio */
class nsIDOMSVGAnimatedPreserveAspectRatioD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDPRESERVEASPECTRATIO_IID;


  alias nsIDOMSVGAnimatedPreserveAspectRatio InnerType;

  this(nsIDOMSVGAnimatedPreserveAspectRatio intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedPreserveAspectRatio opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedPreserveAspectRatio value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGPreserveAspectRatio baseVal; */
  nsIDOMSVGPreserveAspectRatioD  BaseVal(){
    nsIDOMSVGPreserveAspectRatio value;
    nsresult __result = inner.GetBaseVal(&value);
    CheckException(__result);
    return new nsIDOMSVGPreserveAspectRatioD(value);
  }

  /* readonly attribute nsIDOMSVGPreserveAspectRatio animVal; */
  nsIDOMSVGPreserveAspectRatioD  AnimVal(){
    nsIDOMSVGPreserveAspectRatio value;
    nsresult __result = inner.GetAnimVal(&value);
    CheckException(__result);
    return new nsIDOMSVGPreserveAspectRatioD(value);
  }

private:
  nsIDOMSVGAnimatedPreserveAspectRatio inner;
