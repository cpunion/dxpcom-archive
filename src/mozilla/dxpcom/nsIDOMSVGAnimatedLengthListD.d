...
module mozilla.dxpcom.nsIDOMSVGAnimatedLengthListD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedLengthList */
class nsIDOMSVGAnimatedLengthListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDLENGTHLIST_IID;


  alias nsIDOMSVGAnimatedLengthList InnerType;

  this(nsIDOMSVGAnimatedLengthList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedLengthList opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedLengthList value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGLengthList baseVal; */
  nsIDOMSVGLengthListD  BaseVal(){
    nsIDOMSVGLengthList value;
    nsresult __result = inner.GetBaseVal(&value);
    CheckException(__result);
    return new nsIDOMSVGLengthListD(value);
  }

  /* readonly attribute nsIDOMSVGLengthList animVal; */
  nsIDOMSVGLengthListD  AnimVal(){
    nsIDOMSVGLengthList value;
...
private:
  nsIDOMSVGAnimatedLengthList inner;
