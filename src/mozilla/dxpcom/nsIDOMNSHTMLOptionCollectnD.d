...
module mozilla.dxpcom.nsIDOMNSHTMLOptionCollectnD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLOptionCollectn;


public import mozilla.dxpcom.nsIDOMNSHTMLOptionCollectnD;
...
/* starting wrapper class:    nsIDOMNSHTMLOptionCollection */
class nsIDOMNSHTMLOptionCollectionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLOPTIONCOLLECTION_IID;


  alias nsIDOMNSHTMLOptionCollection InnerType;

  this(nsIDOMNSHTMLOptionCollection intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLOptionCollection opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLOptionCollection value) {
    inner = value;
  }
  ...
  void SetOption(PRInt32 index, nsIDOMHTMLOptionElementD option){
    nsresult __result = inner.SetOption(index, option ? cast(nsIDOMHTMLOptionElement)option : null);
    CheckException(__result);
  }

  /* [noscript] readonly attribute nsIDOMHTMLSelectElement select; */
  nsIDOMHTMLSelectElementD  Select(){
    nsIDOMHTMLSelectElement value;
    nsresult __result = inner.GetSelect(&value);
    CheckException(__result);
    return new nsIDOMHTMLSelectElementD(value);
  }

private:
  nsIDOMNSHTMLOptionCollection inner;
