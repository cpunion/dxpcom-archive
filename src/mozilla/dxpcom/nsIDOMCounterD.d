...
module mozilla.dxpcom.nsIDOMCounterD;
...
/* starting wrapper class:    nsIDOMCounter */
class nsIDOMCounterD : public nsISupportsD {

  static const nsIID IID = NS_IDOMCOUNTER_IID;


  alias nsIDOMCounter InnerType;

  this(nsIDOMCounter intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMCounter opCast() {
    return inner;
  }

  void opAssign(nsIDOMCounter value) {
    inner = value;
  }
  ...
  wchar[] Identifier(){
    ...
    nsresult __result = inner.GetIdentifier(cast(nsAString*)value);
  ...
  wchar[] ListStyle(){
    scope auto value = new AString();
    nsresult __result = inner.GetListStyle(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] Separator(){
    scope auto value = new AString();
    nsresult __result = inner.GetSeparator(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
