...
module mozilla.dxpcom.nsIDOMLinkStyleD;
...
/* starting wrapper class:    nsIDOMLinkStyle */
class nsIDOMLinkStyleD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLINKSTYLE_IID;


  alias nsIDOMLinkStyle InnerType;

  this(nsIDOMLinkStyle intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLinkStyle opCast() {
    return inner;
  }

  void opAssign(nsIDOMLinkStyle value) {
    inner = value;
  }

  /* readonly attribute nsIDOMStyleSheet sheet; */
  nsIDOMStyleSheetD  Sheet(){
    nsIDOMStyleSheet value;
    nsresult __result = inner.GetSheet(&value);
    CheckException(__result);
    return new nsIDOMStyleSheetD(value);
  }

private:
  nsIDOMLinkStyle inner;
