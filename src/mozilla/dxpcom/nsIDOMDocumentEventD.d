...
module mozilla.dxpcom.nsIDOMDocumentEventD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMDocumentEvent;


public import mozilla.dxpcom.nsIDOMDocumentEventD;
...
/* starting wrapper class:    nsIDOMDocumentEvent */
/**
 ...
 * @status FROZEN
 */
class nsIDOMDocumentEventD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOCUMENTEVENT_IID;


  alias nsIDOMDocumentEvent InnerType;

  this(nsIDOMDocumentEvent intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDocumentEvent opCast() {
    return inner;
  }

  void opAssign(nsIDOMDocumentEvent value) {
    inner = value;
  }

  /* nsIDOMEvent createEvent (in DOMString eventType)  raises (DOMException); */
  nsIDOMEventD  CreateEvent(wchar[] eventType){
    scope auto _eventType = new AString(eventType);
    nsIDOMEvent _retval;
    nsresult __result = inner.CreateEvent(cast(nsAString*)_eventType, &_retval);
    CheckException(__result);
    return new nsIDOMEventD(_retval);
  }

private:
  nsIDOMDocumentEvent inner;
