...
module mozilla.dxpcom.nsIDOMElementCSSInlineStyleD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMElementCSSInlineStyle;


public import mozilla.dxpcom.nsIDOMElementCSSInlineStyleD;
...
/* starting wrapper class:    nsIDOMElementCSSInlineStyle */
/**
 ...
 * @status FROZEN
 */
class nsIDOMElementCSSInlineStyleD : public nsISupportsD {

  static const nsIID IID = NS_IDOMELEMENTCSSINLINESTYLE_IID;


  alias nsIDOMElementCSSInlineStyle InnerType;

  this(nsIDOMElementCSSInlineStyle intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMElementCSSInlineStyle opCast() {
    return inner;
  }

  void opAssign(nsIDOMElementCSSInlineStyle value) {
    inner = value;
  }
...
private:
  nsIDOMElementCSSInlineStyle inner;
