...
module mozilla.dxpcom.nsIDOMSVGAnimatedPointsD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGAnimatedPoints;


public import mozilla.dxpcom.nsIDOMSVGAnimatedPointsD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedPoints */
class nsIDOMSVGAnimatedPointsD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDPOINTS_IID;


  alias nsIDOMSVGAnimatedPoints InnerType;

  this(nsIDOMSVGAnimatedPoints intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedPoints opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedPoints value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGPointList points; */
  nsIDOMSVGPointListD  Points(){
    nsIDOMSVGPointList value;
    nsresult __result = inner.GetPoints(&value);
    CheckException(__result);
    return new nsIDOMSVGPointListD(value);
  }

  /* readonly attribute nsIDOMSVGPointList animatedPoints; */
  nsIDOMSVGPointListD  AnimatedPoints(){
    nsIDOMSVGPointList value;
    nsresult __result = inner.GetAnimatedPoints(&value);
    CheckException(__result);
    return new nsIDOMSVGPointListD(value);
  }

private:
  nsIDOMSVGAnimatedPoints inner;
