...
module mozilla.dxpcom.nsIDOMSVGStylableD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGStylable;


public import mozilla.dxpcom.nsIDOMSVGStylableD;
...
/* starting wrapper class:    nsIDOMSVGStylable */
class nsIDOMSVGStylableD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGSTYLABLE_IID;


  alias nsIDOMSVGStylable InnerType;

  this(nsIDOMSVGStylable intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGStylable opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGStylable value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGAnimatedString className; */
  nsIDOMSVGAnimatedStringD  ClassName(){
  ...
  nsIDOMCSSValueD  GetPresentationAttribute(wchar[] name){
    scope auto _name = new AString(name);
    nsIDOMCSSValue _retval;
    nsresult __result = inner.GetPresentationAttribute(cast(nsAString*)_name, &_retval);
    CheckException(__result);
    return new nsIDOMCSSValueD(_retval);
  }

private:
  nsIDOMSVGStylable inner;
