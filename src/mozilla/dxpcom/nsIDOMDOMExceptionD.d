...
module mozilla.dxpcom.nsIDOMDOMExceptionD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMDOMException;


public import mozilla.dxpcom.nsIDOMDOMExceptionD;
...
/* starting wrapper class:    nsIDOMDOMException */
/**
 ...
 * @status FROZEN
 */
class nsIDOMDOMExceptionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOMEXCEPTION_IID;


  alias nsIDOMDOMException InnerType;

  this(nsIDOMDOMException intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDOMException opCast() {
    return inner;
  }

  void opAssign(nsIDOMDOMException value) {
    inner = value;
  }
