...
module mozilla.dxpcom.nsIDOMNSDocumentStyleD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSDocumentStyle;


public import mozilla.dxpcom.nsIDOMNSDocumentStyleD;
...
/* starting wrapper class:    nsIDOMNSDocumentStyle */
/**
 ...
 */
class nsIDOMNSDocumentStyleD : public nsIDOMDocumentStyleD {

  static const nsIID IID = NS_IDOMNSDOCUMENTSTYLE_IID;


  alias nsIDOMNSDocumentStyle InnerType;

  this(nsIDOMNSDocumentStyle intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSDocumentStyle opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSDocumentStyle value) {
    inner = value;
  }
  ...
  wchar[] PreferredStylesheetSet(){
    scope auto value = new AString();
    nsresult __result = inner.GetPreferredStylesheetSet(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }

private:
  nsIDOMNSDocumentStyle inner;
