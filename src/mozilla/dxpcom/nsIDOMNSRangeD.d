...
module mozilla.dxpcom.nsIDOMNSRangeD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSRange;


public import mozilla.dxpcom.nsIDOMNSRangeD;
...
/* starting wrapper class:    nsIDOMNSRange */
class nsIDOMNSRangeD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSRANGE_IID;


  alias nsIDOMNSRange InnerType;

  this(nsIDOMNSRange intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSRange opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSRange value) {
    inner = value;
  }

  /* nsIDOMDocumentFragment createContextualFragment (in DOMString fragment); */
  nsIDOMDocumentFragmentD  CreateContextualFragment(wchar[] fragment){
    scope auto _fragment = new AString(fragment);
    nsIDOMDocumentFragment _retval;
    nsresult __result = inner.CreateContextualFragment(cast(nsAString*)_fragment, &_retval);
    CheckException(__result);
    return new nsIDOMDocumentFragmentD(_retval);
  }

  /* boolean isPointInRange (in nsIDOMNode parent, in long offset); */
  PRBool IsPointInRange(nsIDOMNodeD parent, PRInt32 offset){
    PRBool _retval;
    nsresult __result = inner.IsPointInRange(parent ? cast(nsIDOMNode)parent : null, offset, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* short comparePoint (in nsIDOMNode parent, in long offset); */
  PRInt16 ComparePoint(nsIDOMNodeD parent, PRInt32 offset){
    PRInt16 _retval;
    nsresult __result = inner.ComparePoint(parent ? cast(nsIDOMNode)parent : null, offset, &_retval);
    CheckException(__result);
    return _retval;
  }

  /* boolean intersectsNode (in nsIDOMNode n); */
  PRBool IntersectsNode(nsIDOMNodeD n){
    PRBool _retval;
    nsresult __result = inner.IntersectsNode(n ? cast(nsIDOMNode)n : null, &_retval);
    CheckException(__result);
    return _retval;
  }
  ...
  PRUint16 CompareNode(nsIDOMNodeD n){
    PRUint16 _retval;
    nsresult __result = inner.CompareNode(n ? cast(nsIDOMNode)n : null, &_retval);
    CheckException(__result);
    return _retval;
  }
  ...
  /* void nSDetach (); */
  void NSDetach(){
    nsresult __result = inner.NSDetach();
    CheckException(__result);
  }
