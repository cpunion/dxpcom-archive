...
module mozilla.dxpcom.nsIDOMConstructorD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMConstructor;


public import mozilla.dxpcom.nsIDOMConstructorD;
...
/* starting wrapper class:    nsIDOMConstructor */
class nsIDOMConstructorD : public nsISupportsD {

  static const nsIID IID = NS_IDOMCONSTRUCTOR_IID;


  alias nsIDOMConstructor InnerType;

  this(nsIDOMConstructor intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMConstructor opCast() {
    return inner;
  }

  void opAssign(nsIDOMConstructor value) {
    inner = value;
  }
