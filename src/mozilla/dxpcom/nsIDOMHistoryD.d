...
module mozilla.dxpcom.nsIDOMHistoryD;
...
/* starting wrapper class:    nsIDOMHistory */
class nsIDOMHistoryD : public nsISupportsD {

  static const nsIID IID = NS_IDOMHISTORY_IID;


  alias nsIDOMHistory InnerType;

  this(nsIDOMHistory intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMHistory opCast() {
    return inner;
  }

  void opAssign(nsIDOMHistory value) {
    inner = value;
  }
  ...
  wchar[] Current(){
    ...
    nsresult __result = inner.GetCurrent(cast(nsAString*)value);
    CheckException(__result);
  ...
  wchar[] Previous(){
    scope auto value = new AString();
    nsresult __result = inner.GetPrevious(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  wchar[] Next(){
    scope auto value = new AString();
    nsresult __result = inner.GetNext(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  ...
  void Go(PRInt32 aDelta){
    nsresult __result = inner.Go(aDelta);
    CheckException(__result);
  }
