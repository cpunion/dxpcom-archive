...
module mozilla.dxpcom.nsICiterD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsICiter;


public import mozilla.dxpcom.nsICiterD;
...
/* starting wrapper class:    nsICiter */
/** Handle plaintext citations, as in mail quoting.
  * Used by the editor but not dependant on it.
  */
class nsICiterD : public nsISupportsD {

  static const nsIID IID = NS_ICITER_IID;


  alias nsICiter InnerType;
  ...
  void opAssign(nsICiter value) {
    inner = value;
  }

  /* DOMString GetCiteString (in DOMString aInString); */
  wchar[] GetCiteString(wchar[] aInString){
    scope auto _aInString = new AString(aInString);
    scope auto _retval = new AString;
    nsresult __result = inner.GetCiteString(cast(nsAString*)_aInString, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }

  /* DOMString StripCites (in DOMString aInString); */
  wchar[] StripCites(wchar[] aInString){
    scope auto _aInString = new AString(aInString);
    scope auto _retval = new AString;
    nsresult __result = inner.StripCites(cast(nsAString*)_aInString, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }
  ...
  wchar[] Rewrap(wchar[] aInString, PRUint32 aWrapCol, PRUint32 aFirstLineOffset, PRBool aRespectNewlines){
    scope auto _aInString = new AString(aInString);
    scope auto _retval = new AString;
    nsresult __result = inner.Rewrap(cast(nsAString*)_aInString, aWrapCol, aFirstLineOffset, aRespectNewlines, cast(nsAString*)_retval);
    CheckException(__result);
    return _retval.GetString();
  }
