...
module mozilla.dxpcom.nsPICommandUpdaterD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsPICommandUpdater;


public import mozilla.dxpcom.nsPICommandUpdaterD;
...
/* starting wrapper class:    nsPICommandUpdater */
class nsPICommandUpdaterD : public nsISupportsD {

  static const nsIID IID = NS_PICOMMANDUPDATER_IID;


  alias nsPICommandUpdater InnerType;

  this(nsPICommandUpdater intr){
    super(intr);
    this.inner = intr;
  }

  nsPICommandUpdater opCast() {
    return inner;
  }

  void opAssign(nsPICommandUpdater value) {
    inner = value;
  }
  ...
  void CommandStatusChanged(char*aCommandName){
    nsresult __result = inner.CommandStatusChanged(aCommandName);
    CheckException(__result);
  }

private:
  nsPICommandUpdater inner;
