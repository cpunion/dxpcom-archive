...
module mozilla.dxpcom.nsIDOMLSExceptionD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMLSException;


public import mozilla.dxpcom.nsIDOMLSExceptionD;
...
/* starting wrapper class:    nsIDOMLSException */
class nsIDOMLSExceptionD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLSEXCEPTION_IID;


  alias nsIDOMLSException InnerType;

  this(nsIDOMLSException intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLSException opCast() {
    return inner;
  }

  void opAssign(nsIDOMLSException value) {
    inner = value;
  }
