...
module mozilla.dxpcom.nsIDOMLSOutputD;
...
/* starting wrapper class:    nsIDOMLSOutput */
class nsIDOMLSOutputD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLSOUTPUT_IID;


  alias nsIDOMLSOutput InnerType;

  this(nsIDOMLSOutput intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLSOutput opCast() {
    return inner;
  }

  void opAssign(nsIDOMLSOutput value) {
    inner = value;
  }
