...
module mozilla.dxpcom.nsIDOMSVGLengthListD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGLengthList;


public import mozilla.dxpcom.nsIDOMSVGLengthListD;
...
/* starting wrapper class:    nsIDOMSVGLengthList */
class nsIDOMSVGLengthListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGLENGTHLIST_IID;


  alias nsIDOMSVGLengthList InnerType;

  this(nsIDOMSVGLengthList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGLengthList opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGLengthList value) {
    inner = value;
  }
  ...
  nsIDOMSVGLengthD  Initialize(nsIDOMSVGLengthD newItem){
    nsIDOMSVGLength _retval;
    nsresult __result = inner.Initialize(newItem ? cast(nsIDOMSVGLength)newItem : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGLengthD(_retval);
  }

  /* nsIDOMSVGLength getItem (in unsigned long index); */
  nsIDOMSVGLengthD  GetItem(PRUint32 index){
    nsIDOMSVGLength _retval;
  ...
  nsIDOMSVGLengthD  InsertItemBefore(nsIDOMSVGLengthD newItem, PRUint32 index){
    nsIDOMSVGLength _retval;
    nsresult __result = inner.InsertItemBefore(newItem ? cast(nsIDOMSVGLength)newItem : null, index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGLengthD(_retval);
  }

  /* nsIDOMSVGLength replaceItem (in nsIDOMSVGLength newItem, in unsigned long index); */
  nsIDOMSVGLengthD  ReplaceItem(nsIDOMSVGLengthD newItem, PRUint32 index){
    nsIDOMSVGLength _retval;
    nsresult __result = inner.ReplaceItem(newItem ? cast(nsIDOMSVGLength)newItem : null, index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGLengthD(_retval);
  }

  /* nsIDOMSVGLength removeItem (in unsigned long index); */
  nsIDOMSVGLengthD  RemoveItem(PRUint32 index){
    nsIDOMSVGLength _retval;
  ...
  nsIDOMSVGLengthD  AppendItem(nsIDOMSVGLengthD newItem){
    nsIDOMSVGLength _retval;
    nsresult __result = inner.AppendItem(newItem ? cast(nsIDOMSVGLength)newItem : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGLengthD(_retval);
  }

private:
  nsIDOMSVGLengthList inner;
