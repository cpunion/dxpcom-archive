...
module mozilla.dxpcom.nsIDOMCRMFObjectD;
...
/* starting wrapper class:    nsIDOMCRMFObject */
class nsIDOMCRMFObjectD : public nsISupportsD {

  static const nsIID IID = NS_IDOMCRMFOBJECT_IID;


  alias nsIDOMCRMFObject InnerType;

  this(nsIDOMCRMFObject intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMCRMFObject opCast() {
    return inner;
  }

  void opAssign(nsIDOMCRMFObject value) {
    inner = value;
  }
  ...
  wchar[] Request(){
    ...
    nsresult __result = inner.GetRequest(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }

private:
  nsIDOMCRMFObject inner;
