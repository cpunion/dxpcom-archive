...
module mozilla.dxpcom.nsIDOMSVGFitToViewBoxD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGFitToViewBox;


public import mozilla.dxpcom.nsIDOMSVGFitToViewBoxD;
...
/* starting wrapper class:    nsIDOMSVGFitToViewBox */
class nsIDOMSVGFitToViewBoxD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGFITTOVIEWBOX_IID;


  alias nsIDOMSVGFitToViewBox InnerType;

  this(nsIDOMSVGFitToViewBox intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGFitToViewBox opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGFitToViewBox value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGAnimatedRect viewBox; */
  nsIDOMSVGAnimatedRectD  ViewBox(){
    nsIDOMSVGAnimatedRect value;
    nsresult __result = inner.GetViewBox(&value);
    CheckException(__result);
    return new nsIDOMSVGAnimatedRectD(value);
  }
