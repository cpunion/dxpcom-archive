...
module mozilla.dxpcom.nsIDOMSVGZoomAndPanD;
...
/* starting wrapper class:    nsIDOMSVGZoomAndPan */
class nsIDOMSVGZoomAndPanD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGZOOMANDPAN_IID;


  alias nsIDOMSVGZoomAndPan InnerType;

  this(nsIDOMSVGZoomAndPan intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGZoomAndPan opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGZoomAndPan value) {
    inner = value;
  }
  ...
  PRUint16 ZoomAndPan(){
    PRUint16 value;
    nsresult __result = inner.GetZoomAndPan(&value);
    CheckException(__result);
    return value;
  }
  void ZoomAndPan(PRUint16 aZoomAndPan){
    nsresult __result = inner.SetZoomAndPan(aZoomAndPan);
    CheckException(__result);
  }

private:
  nsIDOMSVGZoomAndPan inner;
