...
module mozilla.dxpcom.nsIDOMSVGPathSegListD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMSVGPathSegList;


public import mozilla.dxpcom.nsIDOMSVGPathSegListD;
...
/* starting wrapper class:    nsIDOMSVGPathSegList */
class nsIDOMSVGPathSegListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGPATHSEGLIST_IID;


  alias nsIDOMSVGPathSegList InnerType;

  this(nsIDOMSVGPathSegList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGPathSegList opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGPathSegList value) {
    inner = value;
  }
  ...
  PRUint32 NumberOfItems(){
    PRUint32 value;
    nsresult __result = inner.GetNumberOfItems(&value);
  ...
  nsIDOMSVGPathSegD  Initialize(nsIDOMSVGPathSegD newItem){
    nsIDOMSVGPathSeg _retval;
    nsresult __result = inner.Initialize(newItem ? cast(nsIDOMSVGPathSeg)newItem : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPathSegD(_retval);
  }

  /* nsIDOMSVGPathSeg getItem (in unsigned long index); */
  nsIDOMSVGPathSegD  GetItem(PRUint32 index){
    nsIDOMSVGPathSeg _retval;
    nsresult __result = inner.GetItem(index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPathSegD(_retval);
  }

  /* nsIDOMSVGPathSeg insertItemBefore (in nsIDOMSVGPathSeg newItem, in unsigned long index); */
  nsIDOMSVGPathSegD  InsertItemBefore(nsIDOMSVGPathSegD newItem, PRUint32 index){
    nsIDOMSVGPathSeg _retval;
    nsresult __result = inner.InsertItemBefore(newItem ? cast(nsIDOMSVGPathSeg)newItem : null, index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPathSegD(_retval);
  }

  /* nsIDOMSVGPathSeg replaceItem (in nsIDOMSVGPathSeg newItem, in unsigned long index); */
  nsIDOMSVGPathSegD  ReplaceItem(nsIDOMSVGPathSegD newItem, PRUint32 index){
    nsIDOMSVGPathSeg _retval;
    nsresult __result = inner.ReplaceItem(newItem ? cast(nsIDOMSVGPathSeg)newItem : null, index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPathSegD(_retval);
  }

  /* nsIDOMSVGPathSeg removeItem (in unsigned long index); */
  nsIDOMSVGPathSegD  RemoveItem(PRUint32 index){
    nsIDOMSVGPathSeg _retval;
    nsresult __result = inner.RemoveItem(index, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPathSegD(_retval);
  }

  /* nsIDOMSVGPathSeg appendItem (in nsIDOMSVGPathSeg newItem); */
  nsIDOMSVGPathSegD  AppendItem(nsIDOMSVGPathSegD newItem){
    nsIDOMSVGPathSeg _retval;
    nsresult __result = inner.AppendItem(newItem ? cast(nsIDOMSVGPathSeg)newItem : null, &_retval);
    CheckException(__result);
    return new nsIDOMSVGPathSegD(_retval);
  }

private:
  nsIDOMSVGPathSegList inner;
