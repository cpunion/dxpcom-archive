...
module mozilla.dxpcom.nsIDOMNodeIteratorD;
...
/* starting wrapper class:    nsIDOMNodeIterator */
class nsIDOMNodeIteratorD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNODEITERATOR_IID;


  alias nsIDOMNodeIterator InnerType;

  this(nsIDOMNodeIterator intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNodeIterator opCast() {
    return inner;
  }

  void opAssign(nsIDOMNodeIterator value) {
    inner = value;
  }
