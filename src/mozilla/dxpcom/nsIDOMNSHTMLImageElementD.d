...
module mozilla.dxpcom.nsIDOMNSHTMLImageElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLImageElement;


public import mozilla.dxpcom.nsIDOMNSHTMLImageElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLImageElement */
class nsIDOMNSHTMLImageElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLIMAGEELEMENT_IID;


  alias nsIDOMNSHTMLImageElement InnerType;

  this(nsIDOMNSHTMLImageElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLImageElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLImageElement value) {
    inner = value;
  }
  ...
  wchar[] Lowsrc(){
    ...
    nsresult __result = inner.GetLowsrc(cast(nsAString*)value);
    CheckException(__result);
    return value.GetString();
  }
  void Lowsrc(wchar[] aLowsrc){
    scope auto value = new AString(aLowsrc);
    nsresult __result = inner.SetLowsrc(cast(nsAString*)value);
    CheckException(__result);
  }
  ...
  PRBool Complete(){
    PRBool value;
    nsresult __result = inner.GetComplete(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 NaturalHeight(){
    PRInt32 value;
    nsresult __result = inner.GetNaturalHeight(&value);
    CheckException(__result);
    return value;
  }
  ...
  PRInt32 NaturalWidth(){
    PRInt32 value;
    nsresult __result = inner.GetNaturalWidth(&value);
    CheckException(__result);
    return value;
  }
...
private:
  nsIDOMNSHTMLImageElement inner;
