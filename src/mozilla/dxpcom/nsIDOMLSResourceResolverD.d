...
module mozilla.dxpcom.nsIDOMLSResourceResolverD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMLSResourceResolver;


public import mozilla.dxpcom.nsIDOMLSResourceResolverD;
...
/* starting wrapper class:    nsIDOMLSResourceResolver */
class nsIDOMLSResourceResolverD : public nsISupportsD {

  static const nsIID IID = NS_IDOMLSRESOURCERESOLVER_IID;


  alias nsIDOMLSResourceResolver InnerType;

  this(nsIDOMLSResourceResolver intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMLSResourceResolver opCast() {
    return inner;
  }

  void opAssign(nsIDOMLSResourceResolver value) {
    inner = value;
  }
  ...
  nsIDOMLSInputD  ResolveResource(wchar[] type, wchar[] namespaceURI, wchar[] publicId, wchar[] systemId, wchar[] baseURI){
    ...
    scope auto _baseURI = new AString(baseURI);
    nsIDOMLSInput _retval;
    nsresult __result = inner.ResolveResource(cast(nsAString*)_type, cast(nsAString*)_namespaceURI, cast(nsAString*)_publicId, cast(nsAString*)_systemId, cast(nsAString*)_baseURI, &_retval);
    CheckException(__result);
    return new nsIDOMLSInputD(_retval);
  }

private:
  nsIDOMLSResourceResolver inner;
