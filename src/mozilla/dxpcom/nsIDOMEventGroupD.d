...
module mozilla.dxpcom.nsIDOMEventGroupD;
...
/* starting wrapper class:    nsIDOMEventGroup */
class nsIDOMEventGroupD : public nsISupportsD {

  static const nsIID IID = NS_IDOMEVENTGROUP_IID;


  alias nsIDOMEventGroup InnerType;

  this(nsIDOMEventGroup intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMEventGroup opCast() {
    return inner;
  }

  void opAssign(nsIDOMEventGroup value) {
    inner = value;
  }
 ...
 */
  ...
  PRBool IsSameEventGroup(nsIDOMEventGroupD other){
    PRBool _retval;
    nsresult __result = inner.IsSameEventGroup(other ? cast(nsIDOMEventGroup)other : null, &_retval);
    CheckException(__result);
    return _retval;
  }

private:
  nsIDOMEventGroup inner;
