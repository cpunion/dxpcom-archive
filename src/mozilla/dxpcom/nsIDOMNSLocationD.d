/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIDOMNSLocation.idl
 */

module mozilla.dxpcom.nsIDOMNSLocationD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSLocation;


public import mozilla.dxpcom.nsIDOMNSLocationD;
...
/* starting wrapper class:    nsIDOMNSLocation */
class nsIDOMNSLocationD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSLOCATION_IID;


  alias nsIDOMNSLocation InnerType;

  this(nsIDOMNSLocation intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSLocation opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSLocation value) {
    inner = value;
  }
