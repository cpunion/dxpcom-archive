/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIDOMDOMLocator.idl
 */

module mozilla.dxpcom.nsIDOMDOMLocatorD;
...
/* starting wrapper class:    nsIDOMDOMLocator */
/**
 ...
 */
class nsIDOMDOMLocatorD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOMLOCATOR_IID;


  alias nsIDOMDOMLocator InnerType;

  this(nsIDOMDOMLocator intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDOMLocator opCast() {
    return inner;
  }

  void opAssign(nsIDOMDOMLocator value) {
    inner = value;
  }
  ...
  /* readonly attribute nsIDOMNode errorNode; */
  nsIDOMNodeD  ErrorNode(){
    nsIDOMNode value;
    nsresult __result = inner.GetErrorNode(&value);
    CheckException(__result);
