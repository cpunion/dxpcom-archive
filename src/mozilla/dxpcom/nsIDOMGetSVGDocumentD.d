...
module mozilla.dxpcom.nsIDOMGetSVGDocumentD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMGetSVGDocument;


public import mozilla.dxpcom.nsIDOMGetSVGDocumentD;
...
/* starting wrapper class:    nsIDOMGetSVGDocument */
class nsIDOMGetSVGDocumentD : public nsISupportsD {

  static const nsIID IID = NS_IDOMGETSVGDOCUMENT_IID;


  alias nsIDOMGetSVGDocument InnerType;

  this(nsIDOMGetSVGDocument intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMGetSVGDocument opCast() {
    return inner;
  }

  void opAssign(nsIDOMGetSVGDocument value) {
    inner = value;
  }

  /* nsIDOMSVGDocument getSVGDocument (); */
  nsIDOMSVGDocumentD  GetSVGDocument(){
    nsIDOMSVGDocument _retval;
    nsresult __result = inner.GetSVGDocument(&_retval);
    CheckException(__result);
    return new nsIDOMSVGDocumentD(_retval);
  }

private:
  nsIDOMGetSVGDocument inner;
