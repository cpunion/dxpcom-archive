...
module mozilla.dxpcom.nsIDOMSVGAnimTransformListD;
...
public import mozilla.dxpcom.nsIDOMSVGAnimTransformListD;
...
/* starting wrapper class:    nsIDOMSVGAnimatedTransformList */
class nsIDOMSVGAnimatedTransformListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMSVGANIMATEDTRANSFORMLIST_IID;


  alias nsIDOMSVGAnimatedTransformList InnerType;

  this(nsIDOMSVGAnimatedTransformList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMSVGAnimatedTransformList opCast() {
    return inner;
  }

  void opAssign(nsIDOMSVGAnimatedTransformList value) {
    inner = value;
  }

  /* readonly attribute nsIDOMSVGTransformList baseVal; */
  nsIDOMSVGTransformListD  BaseVal(){
  ...
  nsIDOMSVGTransformListD  AnimVal(){
    nsIDOMSVGTransformList value;
...
private:
  nsIDOMSVGAnimatedTransformList inner;
