...
module mozilla.dxpcom.nsIURIRefObjectD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIURIRefObject;


public import mozilla.dxpcom.nsIURIRefObjectD;
...
/* starting wrapper class:    nsIURIRefObject */
/** A class which can represent any node which points to an
  ...
  */
class nsIURIRefObjectD : public nsISupportsD {

  static const nsIID IID = NS_IURIREFOBJECT_IID;


  alias nsIURIRefObject InnerType;

  this(nsIURIRefObject intr){
    super(intr);
    this.inner = intr;
  }

  nsIURIRefObject opCast() {
    return inner;
  }

  void opAssign(nsIURIRefObject value) {
    inner = value;
  }
  ...
  nsIDOMNodeD  Node(){
    nsIDOMNode value;
    nsresult __result = inner.GetNode(&value);
    CheckException(__result);
    return new nsIDOMNodeD(value);
  }
  void Node(nsIDOMNodeD  aNode){
    nsIDOMNode value;
    nsresult __result = inner.SetNode(value);
    CheckException(__result);
  }
  ...
  wchar[] GetNextURI(){
    ...
    nsresult __result = inner.GetNextURI(cast(nsAString*)_retval);
    CheckException(__result);
  ...
  void RewriteAllURIs(wchar[] aOldPat, wchar[] aNewPat, PRBool aMakeRel){
    scope auto _aOldPat = new AString(aOldPat);
    scope auto _aNewPat = new AString(aNewPat);
    nsresult __result = inner.RewriteAllURIs(cast(nsAString*)_aOldPat, cast(nsAString*)_aNewPat, aMakeRel);
    CheckException(__result);
  }

private:
  nsIURIRefObject inner;
