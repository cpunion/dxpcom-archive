...
module mozilla.dxpcom.nsIDOMRGBColorD;
...
/* starting wrapper class:    nsIDOMRGBColor */
class nsIDOMRGBColorD : public nsISupportsD {

  static const nsIID IID = NS_IDOMRGBCOLOR_IID;


  alias nsIDOMRGBColor InnerType;

  this(nsIDOMRGBColor intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMRGBColor opCast() {
    return inner;
  }

  void opAssign(nsIDOMRGBColor value) {
    inner = value;
  }

  /* readonly attribute nsIDOMCSSPrimitiveValue red; */
  nsIDOMCSSPrimitiveValueD  Red(){
    nsIDOMCSSPrimitiveValue value;
    nsresult __result = inner.GetRed(&value);
    CheckException(__result);
    return new nsIDOMCSSPrimitiveValueD(value);
  }

  /* readonly attribute nsIDOMCSSPrimitiveValue green; */
  nsIDOMCSSPrimitiveValueD  Green(){
    nsIDOMCSSPrimitiveValue value;
    nsresult __result = inner.GetGreen(&value);
    CheckException(__result);
    return new nsIDOMCSSPrimitiveValueD(value);
  }

  /* readonly attribute nsIDOMCSSPrimitiveValue blue; */
  nsIDOMCSSPrimitiveValueD  Blue(){
    nsIDOMCSSPrimitiveValue value;
    nsresult __result = inner.GetBlue(&value);
    CheckException(__result);
    return new nsIDOMCSSPrimitiveValueD(value);
  }

private:
  nsIDOMRGBColor inner;
