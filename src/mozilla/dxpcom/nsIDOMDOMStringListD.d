...
module mozilla.dxpcom.nsIDOMDOMStringListD;
...
/* starting wrapper class:    nsIDOMDOMStringList */
class nsIDOMDOMStringListD : public nsISupportsD {

  static const nsIID IID = NS_IDOMDOMSTRINGLIST_IID;


  alias nsIDOMDOMStringList InnerType;

  this(nsIDOMDOMStringList intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMDOMStringList opCast() {
    return inner;
  }

  void opAssign(nsIDOMDOMStringList value) {
    inner = value;
  }
