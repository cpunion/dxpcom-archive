...
module mozilla.dxpcom.nsIEditorIMESupportD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIEditorIMESupport;


public import mozilla.dxpcom.nsIEditorIMESupportD;
...
/* starting wrapper class:    nsIEditorIMESupport */
class nsIEditorIMESupportD : public nsISupportsD {

  static const nsIID IID = NS_IEDITORIMESUPPORT_IID;


  alias nsIEditorIMESupport InnerType;

  this(nsIEditorIMESupport intr){
    super(intr);
    this.inner = intr;
  }

  nsIEditorIMESupport opCast() {
    return inner;
  }

  void opAssign(nsIEditorIMESupport value) {
    inner = value;
  }
  ...
  void BeginComposition(nsTextEventReply * aReply){
    nsresult __result = inner.BeginComposition(aReply);
  ...
  void SetCompositionString(wchar[] aCompositionString, nsIPrivateTextRangeList * aTextRange, nsTextEventReply * aReply){
    scope auto _aCompositionString = new AString(aCompositionString);
    nsresult __result = inner.SetCompositionString(cast(nsAString*)_aCompositionString, aTextRange, aReply);
    CheckException(__result);
  }
  ...
  /* void endComposition (); */
  void EndComposition(){
    nsresult __result = inner.EndComposition();
    CheckException(__result);
  }
  ...
  void QueryComposition(nsTextEventReply * aReply){
    nsresult __result = inner.QueryComposition(aReply);
    CheckException(__result);
  }
  ...
  void ForceCompositionEnd(){
    nsresult __result = inner.ForceCompositionEnd();
    CheckException(__result);
  }
  ...
  void GetReconversionString(nsReconversionEventReply * aReply){
    nsresult __result = inner.GetReconversionString(aReply);
    CheckException(__result);
  }
  ...
  void NotifyIMEOnFocus(){
    nsresult __result = inner.NotifyIMEOnFocus();
    CheckException(__result);
  }
  ...
  void NotifyIMEOnBlur(){
    nsresult __result = inner.NotifyIMEOnBlur();
    CheckException(__result);
  }
  ...
  void GetQueryCaretRect(nsQueryCaretRectEventReply * aReply){
    nsresult __result = inner.GetQueryCaretRect(aReply);
    CheckException(__result);
  }

private:
  nsIEditorIMESupport inner;
