...
module mozilla.dxpcom.nsIDOMNSHTMLFrameElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLFrameElement;


public import mozilla.dxpcom.nsIDOMNSHTMLFrameElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLFrameElement */
class nsIDOMNSHTMLFrameElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLFRAMEELEMENT_IID;


  alias nsIDOMNSHTMLFrameElement InnerType;

  this(nsIDOMNSHTMLFrameElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLFrameElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLFrameElement value) {
    inner = value;
  }

  /* readonly attribute nsIDOMWindow contentWindow; */
  nsIDOMWindowD  ContentWindow(){
    nsIDOMWindow value;
    nsresult __result = inner.GetContentWindow(&value);
    CheckException(__result);
    return new nsIDOMWindowD(value);
  }

private:
  nsIDOMNSHTMLFrameElement inner;
