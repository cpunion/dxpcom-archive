...
module mozilla.dxpcom.nsIDOMNSHTMLButtonElementD;

public import mozilla.dxpcom.nsrootidlD;


public import mozilla.xpcom.nsIDOMNSHTMLButtonElement;


public import mozilla.dxpcom.nsIDOMNSHTMLButtonElementD;
...
/* starting wrapper class:    nsIDOMNSHTMLButtonElement */
class nsIDOMNSHTMLButtonElementD : public nsISupportsD {

  static const nsIID IID = NS_IDOMNSHTMLBUTTONELEMENT_IID;


  alias nsIDOMNSHTMLButtonElement InnerType;

  this(nsIDOMNSHTMLButtonElement intr){
    super(intr);
    this.inner = intr;
  }

  nsIDOMNSHTMLButtonElement opCast() {
    return inner;
  }

  void opAssign(nsIDOMNSHTMLButtonElement value) {
    inner = value;
  }
...
private:
  nsIDOMNSHTMLButtonElement inner;
